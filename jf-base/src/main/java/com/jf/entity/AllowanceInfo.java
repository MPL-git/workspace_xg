...
public class AllowanceInfo extends Model {
    private Integer id;
    ...
    public void setLadderFlag(String ladderFlag) {
        this.ladderFlag = ladderFlag == null ? null : ladderFlag.trim();
    }
    ...
    public Date getUsageBeginTime() {
        return usageBeginTime;
    }

    public void setUsageBeginTime(Date usageBeginTime) {
    ...
    public void setAllowanceDescription(String allowanceDescription) {
        this.allowanceDescription = allowanceDescription == null ? null : allowanceDescription.trim();
    }

...
public class CutPriceCnfTplDtl {
    private Integer id;

    private Integer cutPriceCnfTplId;
    ...
    public Integer getCutPriceCnfTplId() {
        return cutPriceCnfTplId;
    }

    public void setCutPriceCnfTplId(Integer cutPriceCnfTplId) {
        this.cutPriceCnfTplId = cutPriceCnfTplId;
    }

...
public class MchtBrandAptitudePic {
    private Integer id;
    ...
    private Integer mchtBrandAptitudeId;
    ...
    public Integer getMchtBrandAptitudeId() {
        return mchtBrandAptitudeId;
    }

    public void setMchtBrandAptitudeId(Integer mchtBrandAptitudeId) {
        this.mchtBrandAptitudeId = mchtBrandAptitudeId;
    }

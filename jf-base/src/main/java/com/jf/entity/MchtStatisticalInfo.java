...
public class MchtStatisticalInfo {
    ...
    private Integer productSaleCount7Day;
    ...
    private Integer productSaleCount30Day;
    ...
    public Integer getProductSaleCount7Day() {
        return productSaleCount7Day;
    }

    public void setProductSaleCount7Day(Integer productSaleCount7Day) {
        this.productSaleCount7Day = productSaleCount7Day;
    }
    ...
    public Integer getProductSaleCount30Day() {
        return productSaleCount30Day;
    }

    public void setProductSaleCount30Day(Integer productSaleCount30Day) {
        this.productSaleCount30Day = productSaleCount30Day;
    }

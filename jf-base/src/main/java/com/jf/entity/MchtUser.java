...
public class MchtUser extends Model {
    private Integer id;
    ...
    public void setIsMobileValidate(String isMobileValidate) {
        this.isMobileValidate = isMobileValidate == null ? null : isMobileValidate.trim();
    }
    ...
    public void setIsLoginValidate(String isLoginValidate) {
        this.isLoginValidate = isLoginValidate == null ? null : isLoginValidate.trim();
    }

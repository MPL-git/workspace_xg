...
<head>
    ...
    <link rel="stylesheet" href="../../../../template/01/css/tmpl.css">
    <link rel="stylesheet" href="../../../../template/01/themes/06/css/theme.css">
    <link rel="stylesheet" href="../../../../css/layout-w1000.css">
...
<style>
.search-panel-fields input{width:200px; height:25px; *line-height:25px;}
.search-panel-fields label{line-height:25px;}
.search-panel-fields button{height:21px;}
#headerSearch{ width: 275px;}
#headerCart{ display: none;}
.gbc-blockcon{padding:3px 0;}
.txnz_cart{position: relative;}
.txnz_cart a{ position: absolute;right: -10px; top: 146px; width: 100px; display: block; background: #7b8d43; text-align: center; padding:0!important; height: 40px; color: #fff; font-size: 14px;}
.txnz_cart em{ display: inline-block; margin-right: 5px; width: 28px; height: 40px; background: url(/static/template/01/themes/06/images/ico-shopcart.png) no-repeat 50% 5px; vertical-align: middle;}
</style>
	...
	<div class="topbar">
        <div class="layout">
			...
			<div class="toplinks">
                ...
                <div class="txnz_cart"><a href="/cart/" target="_self" title="" _href="/cart/"><em></em>&nbsp;购物车&nbsp;</a></div>
			</div>
	        <div class="toplogin">
...
<div id="gotop">
<style>
#qrcode_weibo,#qrcode_weixin{ display: none; position: absolute; right: 80px; border: 1px solid #ededed; padding: 5px; background: #fff;}
#qrcode_weixin{top: 64px;}
#qrcode_weibo{ top: 136px;}
</style>
    <img src="images/pic/kefu.png" alt="" usemap="#Map2"/>
	<map name="Map2">
		<area shape="rect" coords="4,4,77,101" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1605543601&site=qq&menu=yes">
		<area shape="rect" coords="3,102,78,170" href="javascript:void(0)" onmouseover="$('#qrcode_weixin').show()" onmouseout="$('#qrcode_weixin').hide()">
		<area shape="rect" coords="3,171,78,232" target="_blank" href="http://weibo.com/tingxifarm" onmouseover="$('#qrcode_weibo').show()" onmouseout="$('#qrcode_weibo').hide()">
		<area shape="rect" coords="3,234,77,292" href="#top">
	</map>
    <div id="qrcode_weixin"><img src="images/pic/qrcode-weixin.png" alt=""/></div>
    <div id="qrcode_weibo"><img src="images/pic/qrcode-weibo.png" alt=""/></div>
</div>
</body>
</html>
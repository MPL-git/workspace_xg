...
public class CommonFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp,
         ...
         if(request.getAttribute("reqPRM")!=null){
     		...
     		if(paramJson.containsKey("token") && StringUtil.isBlank(paramJson.getString("token")) && paramJson.containsKey("reqData")){
     			JSONObject reqDataJson = paramJson.getJSONObject("reqData");// 获取请求参数
    			if(!JsonUtils.isEmpty(reqDataJson, "memberId")){
     				reqDataJson.put("memberId", null);
     			}
     		}

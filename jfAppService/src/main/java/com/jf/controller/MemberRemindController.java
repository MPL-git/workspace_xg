...
public class MemberRemindController extends BaseController{
	...
	public ResponseMsg addRemindSale(HttpServletRequest request){
		try {
			...
			Object[] obj = {"memberId","remindType","remindId"};
...
//			JSONObject reqDataJson = reqPRM.getJSONObject("reqData");// 获取请求参数
//			
//			Object[] obj = {"memberId","remindType","pageSize","currentPage"};
//			this.requiredStr(obj,request);
//			
//			Integer memberId = reqDataJson.getInt("memberId");//会员id
//			//1 活动开售 2 商品开售
...
//				List<MemberRemindCustom> memberRemindListSize = memberRemindService.getProductRemindList(params);
//				Page page = new Page(currentPage, pageSize, memberRemindListSize.size());
...
//				List<MemberRemindCustom> memberRemindListSize = memberRemindService.getActivityRemindList(params);
//				Page page = new Page(currentPage, pageSize, memberRemindListSize.size());
//				params.put("pageSize", pageSize);
//				params.put("currentPage", currentPage*pageSize);
...
//	}
	...
	public ResponseMsg getRemindSaleRecordList(HttpServletRequest request){
		try {
			...
			Object[] obj = {"memberId","remindType","currentPage"};
			this.requiredStr(obj,request);
			
			Integer memberId = reqDataJson.getInt("memberId");//会员id
			//1 活动开售 2 商品开售 3 店铺 4视频
			String remindType = reqDataJson.getString("remindType");

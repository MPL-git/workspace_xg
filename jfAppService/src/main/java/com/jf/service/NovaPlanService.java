...
public class NovaPlanService{
	...
	public static final int NOVA_TASK_COUNT = 6;//醒购新星计划任务邀请人数
	public static final int DYNAMICS_TASK_COUNT = 15;//签约期间发布动态数量
	public static final int SIGN_IN_COUNT = 15;//累计签到天数
	public static final int MEMBER_SUB_ORDER_COUNT = 10;//会员下级订单数量

	public Map<String, Object> getNovaPlanIndex(JSONObject reqPRM, JSONObject reqDataJson) {
	...
	private List<Map<String, Object>> getEveryDateTaskList(MemberInfo memberInfo, Integer memberId, String openType, int memberSubCount) {
		...
		Integer memberIsSignCount = memberSignInSettingService.getMemberSignInCount(memberId);
		String statusText = "";
		Map<String, Object> dataMap = new HashMap<>();
		//邀请好友
		dataMap = new HashMap<>();
		...
		dataMap.put("statusText", statusText);
		dataMap.put("status", statusText.equals("已完成") ? 1 : 0);
		dataMap.put("linkUrl", commonService.getCloumnLinkUrl("", "1"));
	...
	public Map<String, Object> getMemberRenewalTaskProgress(JSONObject reqPRM, JSONObject reqDataJson) {
		Integer memberId = reqDataJson.getInt("memberId");
		Map<String, Object> taskProMap = getRenewalTaskPro(memberInfoService.selectByPrimaryKey(memberId), memberId, "2");
	...
	public Map<String, Object> addMemberOpenNovaPlan(JSONObject reqPRM, JSONObject reqDataJson) {
		Integer memberId = reqDataJson.getInt("memberId");
		MemberInfo memberInfo = memberInfoService.selectByPrimaryKey(memberId);
		String openType = getNovaPlanOpenType(memberInfo, memberId);
	...
	public Map<String, Object> getMemberAttentions(JSONObject reqPRM, JSONObject reqDataJson) {

...
public class WeixinService {
	...
	public String createAppletUnlimitQrcode(String page, String scene) {
		Map<String, Object> paramMap = buildParams(page, scene);
	...
	public String createAndGetAppletUnLimitQrCode(String page, String scene) {
		Map<String, Object> paramMap = buildParams(page, scene);

		String fileName = String.valueOf(System.currentTimeMillis());
		String targetPath = FileUtil.getRandomFileName(fileName , 10, 0)+".jpg";
		boolean success = WeChatSendUtil.sendPost(Const.WXA_CODE_UNLIMIT + WeixinUtil.getXcxAccessToken(), paramMap, Config.getProperty("annex.filePath").concat(targetPath));
		return success ? targetPath : null;
	}

	private Map<String, Object> buildParams(String page, String scene) {

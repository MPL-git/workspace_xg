...
public class CouponRainConverter {
    ...
    public GetCouponRainResponse buildCouponRainResponse(CouponRain couponRain, CouponRainSetup couponRainSetup) {
        ...
        String couponRainPage = StringUtil.buildMsg("{}/xgbuy/views/activity/redRain/index.html", Config.getProperty("mUrl"));
        response.setCouponRainPage(couponRainPage);
        return response;
    ...
    public SettleCouponRainResponse buildSettleCouponRainResponse(CouponRainSettleContext context, CouponRain nextRain, boolean shareAble) {

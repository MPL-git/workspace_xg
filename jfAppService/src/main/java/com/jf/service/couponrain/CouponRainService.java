...
public class CouponRainService extends AppBaseService<CouponRain, CouponRainExample> {
    ...
    public CouponRain getEnableFirstRain(Integer memberId) {
        return couponRainCustomMapper.getEnableFirstRain(memberId);
    }
    ...
    public CouponRainSettleContext settle(Integer memberId, Integer recordId, Integer score) {
        ...
        logger.debug("用户【{}】红包雨活动记录ID:{},获取积分红包{}个,券红包{}个", memberId, recordId, context.getIntegralPackCount(), context.getCouponPackCount());

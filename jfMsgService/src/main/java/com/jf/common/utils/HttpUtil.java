...
public class HttpUtil {
     ...
     * @throws IOException
     */
    public static String SendPostMultipartRequest(String actionUrl, Map<String, String> params, Map<String, File> files) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(HttpUtil.sendGetRequest("https://www.baidu.com"));

 ...
 <script type="text/javascript">
	 ...
	 function updateActivityArea(activityAreaId){
		$.ligerDialog.open({
			...
			title: "修改会场信息",
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/activityAreaNew/addOrUpdateOrShowActivityAreaManager.shtml?statusPage=1&activityAreaId="+activityAreaId,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
	 ...
	 function activityAreaPreferentialManager(activityAreaId){
		$.ligerDialog.open({
			...
			title: "会场活动优惠设置",
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/activityAreaNew/activityAreaPreferentialManager.shtml?activityAreaId="+activityAreaId,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
 	 ...
 	 var listConfig={
	      ...
	      btnItems:[{ text: '创建会场', icon: 'add', dtype:'win',  click: itemclick, url:'/activityAreaNew/addOrUpdateOrShowActivityAreaManager.shtml?statusPage=1', seqId:"", width : 1200, height:800}],
	      listGrid:{ columns: [
	                        ...
	                        {display:'修改操作',name:'', align:'center', isSort:false, width:180, render:function(rowdata, rowindex) {
	                        	var html = [];
	                        ...
	                        {display:'通过报名数',name:'', align:'center', isSort:false, width:80, render:function(rowdata, rowindex) {

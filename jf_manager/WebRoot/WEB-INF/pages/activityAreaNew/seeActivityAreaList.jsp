...
<head>
 ...
 <script type="text/javascript">
	 ...
	 //查看报名
	 function activitySee(statusPage, activityAreaId) {
		$.ligerDialog.open({
 	 ...
 	 var listConfig={
	      ...
	      listGrid:{ columns: [
	                        ...
	                        {display:'查看/操作',name:'', align:'center', isSort:false, width:260, render:function(rowdata, rowindex) {
								...
								if(rowdata.type == '1') {
									html.push("<a href=\"javascript:activitySee('', "+rowdata.id+");\">【查看报名】</a>");
								}
								if(rowdata.type == '2') {
									html.push("<a href=\"javascript:showActivityProduct('3', " + rowdata.id + ");\">【查看单品】</a>");
								}
							    return html.join("");
	                        }},

...
<head>
 ...
 var listConfig={
      ...
      listGrid:{ columns: [ 
						...
						{display:'用户ID',name:'memberId', align:'center', isSort:false, width:130},
						{display:'收货人',name:'receiverName', align:'center', isSort:false, width:100},
						{display:'收货地址',name:'receiverAddress', align:'center', isSort:false, width:300},
						{display:'IMEI',name:'reqImei', align:'center', isSort:false, width:200}
		                ],   

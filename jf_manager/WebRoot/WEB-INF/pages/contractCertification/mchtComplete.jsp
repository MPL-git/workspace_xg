        ...
        var listConfig = {
            ...
            listGrid: {
                columns: [
                    ...
                    { display: '品牌资质归档状态', name: 'OPER4', width: 250, align: 'center', render: function(rowdata, rowindex) {
...
<form id="dataForm" runat="server">
    <input type="hidden" name="archiveStatus" value="1">
    <input type="hidden" name="mchtBrandArchiveStatus" value="1">
    <input type="hidden" name="companyInfoArchiveStatus" value="1">
...
<script type="text/javascript">
	...
	function viewMchtProductBrandPics(id) {
		$.ligerDialog.open({
			...
			title: "品牌资质归档",
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/mcht/viewMchtProductBrandPics.shtml?id=" + id + "&hideRadio=1",
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
    ...
    $(function () {
        ...
        $("#export").bind('click', function () {
            ...
            location.href = "${pageContext.request.contextPath}/contractCertification/mchtComplete/export.shtml?" + params;
        });
    });
</script>
</body>

	 ...
	 function formatMoney(s, n) {
 	 ...
 	 var listConfig={
	      ...
	      listGrid:{ columns: [
							...
							{display:'助力情况',name:'', align:'center', isSort:false, width:260, render:function(rowdata, rowindex) {
								if (rowdata.status ==  '1') {
									return "助力成功";
								} else {
									return "等待下载APP助力";
			                ...
			                {display:'助力时间',name:'', align:'center', isSort:false, width:160, render:function(rowdata, rowindex) {
			                ...
			                {display:'完成助力时间',name:'', align:'center', isSort:false, width:160, render:function(rowdata, rowindex) {

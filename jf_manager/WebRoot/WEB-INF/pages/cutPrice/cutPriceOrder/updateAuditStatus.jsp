...
<script type="text/javascript">
	...
	<form name="form1" class="form1" method="post" id="form1" action="${pageContext.request.contextPath}/cutPriceOrder/updateAuditStatus.shtml" >
		...
		<table class="gridtable">
	           	...
	           	<tr>
					...
					<td align="left" class="l-table-edit-td" >
						<span style="margin-left: 10px;">
							<label>
								<input type="radio" name="auditStatus" value="1" checked="checked" />审核通过
							</label>
						</span>
						<span style="margin-left: 30px;">
							<label>
								<input type="radio" name="auditStatus" value="2" />审核驳回
							</label>
						</span>
					</td>
	           	</tr>
			...
			<c:if test="${auditStatus == '2' }">
				<tr>
	            	<td class="title" width="20%">上次审核失败原因</td>
					<td align="left" class="l-table-edit-td" >${cutPriceOrder.auditRemarks }</td>
	           	</tr>
	           	<tr>
	            	<td class="title" width="20%">审核结果<span class="required">*</span></td>
					<td align="left" class="l-table-edit-td" >
						...
						<span style="margin-left: 30px;">
							<label>
								<input type="radio" name="auditStatus" value="2" checked="checked" />审核驳回
							</label>
						</span>
					</td>
	           	</tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" >
					<textarea cols="30" rows="5" type="text" id="auditRemarks" name="auditRemarks" validate="{maxlength:125}" ></textarea>
				</td>
           	</tr>
			<tr>

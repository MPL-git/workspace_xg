...
<head>
 ...
 var listConfig={
     url:"/operateData/brandReport/brandreportdata.shtml",
     listGrid:{ columns: [
						{ display: '品牌ID',name:'product_brandId',width: 150},
						{ display: '品牌名称',name:'product_brandname',width: 150},
						{ display: '品牌汇总',name:'',width: 150,render:function(rowdata, rowindex){
							var html = [];							

...
<head>
 ...
 function addManuallyViolateOrder(subOrderCode,mchtCode) {
		$.ligerDialog.open({
			...
			title: "添加人工发起违规",
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/orderEfficiencyData/outOfStockOrder/addManuallyViolateOrder.shtml?subOrderCode=" + subOrderCode+"&mchtCode="+mchtCode,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
 ...
 var listConfig={
     url:"/orderEfficiencyData/outOfStockOrder/data.shtml",
     listGrid:{ columns: [

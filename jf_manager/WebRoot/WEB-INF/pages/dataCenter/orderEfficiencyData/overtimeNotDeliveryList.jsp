...
<head>
 ...
 var listConfig={
     url:"/orderEfficiencyData/overtimeNotDelivery/data.shtml",
     listGrid:{ columns: [
			            ...
			            { display: '发货跟单状态', width: 80,render: function (rowdata, rowindex) {
			            	if(rowdata.overtimeFollowStatusDesc){
								return rowdata.overtimeFollowStatusDesc;	                		
			            	}else{
								return "未处理";	                		
			            	}
		                }},
	...
	<form id="dataForm" runat="server">
		...
		<div class="search-tr">	
			...
			<div class="search-td">
				...
				<div class="search-td-combobox-condition" >
					<select id="overtimeFollowBy" name="overtimeFollowBy">
						<option value="">请选择</option>
			...
			<div class="search-td">
				...
				<div class="search-td-combobox-condition" >
					<select id="overtimeFollowStatus" name="overtimeFollowStatus">
						<option value="">请选择</option>

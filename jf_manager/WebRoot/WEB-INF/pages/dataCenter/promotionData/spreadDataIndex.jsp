...
<html>
  <head>
	...
	<form name="form1" class="form1" id="form1" action="${pageContext.request.contextPath}/promotionData/srpeadDataImport/updateOrSaveSpreadDatas.shtml" method="post" enctype="multipart/form-data">

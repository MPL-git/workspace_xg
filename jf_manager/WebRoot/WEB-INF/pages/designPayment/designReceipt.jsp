...
<script type="text/javascript">
    ...
    //导出
    function excel(){
        $("#dataForm").attr("action","${pageContext.request.contextPath}/desiPayment/exportDesignReceiptList.shtml");
        $("#dataForm").submit();
    }

    var listConfig = {
        url:"/desiPayment/designReceiptList.shtml",
        btnItems:[],
        listGrid:{ columns: [
    ...
    function getTotalPayAmount() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/desiPayment/getDesignReceiptTotalPayment.shtml",
            type: 'POST',
            dataType: 'json',
        ...
        <div class="search-tr">
            <div class="search-td" style="width: 40%;">
                ...
                <div class="l-panel-search-item" >
                    <input type="text" id="payDateBegin" name="payDateBegin" class="dateEditor" value="${monthBegin}" style="width: 135px;" />
                </div>
                <div class="l-panel-search-item" style="margin-left: 15px;margin-right: 15px;" >至</div>
                <div class="l-panel-search-item">
                    <input type="text" id="payDateEnd" name="payDateEnd" class="dateEditor" value="${monthEnd}" style="width: 135px;" />
                </div>
            </div>

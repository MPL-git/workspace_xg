...
<script type="text/javascript">
	...
	//导出
	function excel(){
		$("#dataForm").attr("action","${pageContext.request.contextPath}/designReceivablesDtl/count/export.shtml");
		$("#dataForm").submit();
	}
	...
	var listConfig = {
		url:"/desiPayment/designReceiptList.shtml?tag=1",
		btnItems:[],
		listGrid:{ columns: [
	...
	function getTotalPayAmount() {
		...
		$.ajax({
			url: "${pageContext.request.contextPath}/desiPayment/getDesignReceiptTotalPayment.shtml?tag=1",
			type: 'POST',
			dataType: 'json',

    ...
    <script type="text/javascript">
                ...
                success : function(data) {
                    if ("0000" == data.returnCode) {
                        ...
                        $.ligerDialog.open({
                            ...
                            title: title,
                            name: "INSERT_WINDOW",
                            url: "${pageContext.request.contextPath}/flowReport/shopProductShow.shtml?id="+id+"&reportColumnId="+reportColumnId+"&type=3"+"&payBegin="+payBegin+"&payEnd="+payEnd,
                            showMax: true,
                            showToggle: false,
                            showMin: false,
                            isResize: true,
                ...
                success : function(data) {
                    if ("0000" == data.returnCode) {
                        ...
                        $.ligerDialog.open({
                            ...
                            title: title,
                            name: "INSERT_WINDOW",
                            url: "${pageContext.request.contextPath}/flowReport/shopBrandShow.shtml?id="+id+"&reportColumnId="+reportColumnId+"&type=3"+"&payBegin="+payBegin+"&payEnd="+payEnd,
                            showMax: true,
                            showToggle: false,
                            showMin: false,
                            isResize: true,
                ...
                success : function(data) {
                    if ("0000" == data.returnCode) {
                        ...
                        $.ligerDialog.open({
                            ...
                            title: title,
                            name: "INSERT_WINDOW",
                            url: "${pageContext.request.contextPath}/flowReport/shopShow.shtml?id="+id+"&reportColumnId="+reportColumnId+"&type=3"+"&payBegin="+payBegin+"&payEnd="+payEnd,
                            showMax: true,
                            showToggle: false,
                            showMin: false,
                            isResize: true,
        ...
        function getVisitorCount(flagId, payBegin,payEnd) {
            ...
            $.ajax({
                ...
                data: {type:"productType",reportColumnId : reportColumnId, productTypeId : productTypeId, flagId : flagId, payBegin : payBegin,payEnd:payEnd},
                dataType: 'json',
                success: function(data) {
        ...
        var listConfig={
            url:"/flowReport/categoryFlowReportData.shtml",
            listGrid:{ columns: [
                    ...
                    {display:'操作',name:'', align:'center', isSort:false, width:180, render: function(rowdata, rowindex) {
                            var html = [];
                            html.push("<a href='javascript:;' onclick='showProduct("+rowdata.typeId+",\""+rowdata.name+"\");'>查看商品</a>&nbsp&nbsp");
                            html.push("<a href='javascript:;' onclick='showBrand("+rowdata.typeId+",\""+rowdata.name+"\")'>查看品牌</a>&nbsp&nbsp");
                            html.push("<a href='javascript:;' onclick='showShop("+rowdata.typeId+",\""+rowdata.name+"\")'>查看店铺</a>");
                            return html.join("");
                        }},
...
<form id="dataForm" runat="server">
    ...
    <div class="search-pannel">
        <div class="search-tr">
            ...
            <div class="search-td">
                <div class="search-td-label">类目名称：</div>

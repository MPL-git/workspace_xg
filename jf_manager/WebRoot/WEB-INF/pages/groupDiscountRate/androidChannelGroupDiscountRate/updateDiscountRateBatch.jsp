...
<script type="text/javascript">
	...
	<form name="form1" class="form1" method="post" id="form1" action="${pageContext.request.contextPath}/androidChannelGroupDiscountRate/updateDiscountRateBatch.shtml" >
		<table class="gridtable">
			<tr>
            	<td class="title" width="20%">渠道集合名称<span class="required">*</span></td>
				<td align="left" class="l-table-edit-td" >
					<select id="groupNameId" name="groupNameId" style="width: 160px;" >

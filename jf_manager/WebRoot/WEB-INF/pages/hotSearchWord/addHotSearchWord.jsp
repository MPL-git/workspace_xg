...
<script type="text/javascript">
	...
	<form name="form1" class="form1" method="post" id="form1" action="${pageContext.request.contextPath}/hotSearchWord/addHotSearchWord.shtml" >
		<table class="gridtable">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" >
					<label style="margin-left: 20px;"><input type="radio" id="status" name="status" value="0" checked />下架</label>

 ...
 <script type="text/javascript">
	...
	function updateArtNo(hotSearchWordId) {
		...
		if(seqNo != '' && flag != null) {
			$.ajax({
				 type : 'POST',
				 url : "${pageContext.request.contextPath}/hotSearchWord/updateSeqNo.shtml",
				 ...
				 success : function(data){
					 if(data == null || data.code != 200)
						 ...
						 $("#seqNo" + hotSearchWordId).parent().append("<span style='color:#009999;'>更改成功</span>");
	...
	function updateStatus(hotSearchWordId, status) {
		...
		$.ligerDialog.confirm(titleStr, function(yes) {
			if(yes) {
				$.ajax({
					 type : 'POST',
					 url : "${pageContext.request.contextPath}/hotSearchWord/updateStatus.shtml",
	...
	function delHotSearchWord(hotSearchWordId) {
		$.ligerDialog.confirm('是否删除？', function(yes) {
			if(yes) {
				$.ajax({
					 type : 'POST',
					 url : "${pageContext.request.contextPath}/hotSearchWord/delHotSearchWord.shtml",
	...
	function addHotSearchWord() {
		 $.ligerDialog.open({
				...
				title: "添加",
				name: "INSERT_WINDOW",
				url: "${pageContext.request.contextPath}/hotSearchWord/addHotSearchWordManager.shtml",
				showMax: true,
				showToggle: false,
				showMin: false,
				isResize: true,
 	...
 	var listConfig={
	      url:"/hotSearchWord/getHotSearchWordList.shtml",
	      btnItems:[
	      ...
	      listGrid:{ columns: [
	                        ...
	                        {display:'搜索次数（近100天）', name:'searchCount100Days', align:'center', isSort:false, width:180},
		...
		<div class="search-pannel">
			<div class="search-tr"  > 
				...
				<div class="search-td" style="width: 40%;">
					<div class="search-td-label" style="float: left;width: 20%;">搜索次数：</div>
					<div class="l-panel-search-item" >
						<input type="text" id="beginSearchLogCount" name="beginSearchLogCount" />
					</div>
					<div class="l-panel-search-item" style="margin-left: 15px;margin-right: 15px;" >至</div>
					<div class="l-panel-search-item">
						<input type="text" id="endSearchLogCount" name="endSearchLogCount" />
					</div>
				</div>

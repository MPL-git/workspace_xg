...
<script type="text/javascript">
	...
	function editUpdateBy(id){
		  $.ligerDialog.open({
			...
			title: "批量变更",
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/interventionOrder/editUpdateByManager.shtml?ids="+id,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
	...
	var listConfig = {
		url : "/interventionOrder/getInterventionOrderList.shtml?statusFlag=1",
		btnItems:[
		...
		listGrid : {
			columns : [{display:'申请介入编号', name:'interventionCode', align:'center', isSort:false, width:180, render: function (rowdata, rowindex) {
					...
					{display:'操作', name:'', align:'center', isSort:false, width:100, render:function(rowdata, rowindex) {
						if (rowdata.platformProcessor != null) {
							return "<a href=\"javascript:showInterventionOrder("+ rowdata.id + ", 1);\">查看</a>";
						} else {
							return "";
						}
					}}
	...
	<form id="dataForm" runat="server">
		...
		<div class="search-pannel">
			<div class="search-tr">
				...
				<div class="search-td">
					<div class="search-td-label" style="float:left;">最后更新日期：</div>
					<div class="l-panel-search-item">
						<input type="text" id="updateDateStart" name="updateDateStart" class="dateEditor" />
					</div>
					<div class="l-panel-search-item">&nbsp;&nbsp;至：</div>
				</div>
				<div class="search-td">

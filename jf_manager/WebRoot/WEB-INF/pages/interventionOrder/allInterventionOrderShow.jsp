...
<body>
	...
	<c:if test="${interventionOrderCustom.status == '2' or (interventionOrderCustom.status == '7' and not empty interventionOrderCustom.directorReason) }">
		<div class="title-top">
			<div class="table-title">
				<span>平台受理</span>
			</div>
			<table class="gridtable marT10 status-table">
	               ...
	               <td>
	               		<select id="rejectReason" name="rejectReason" style="width: 50%;" disabled="disabled" >
	...
	<c:if test="${not empty interventionOrderCustom.directorReason }">
		<div class="title-top" >
			<div class="table-title">
				<span>关闭审核</span>
			</div>
			<table class="gridtable marT10 directorStatus-table" >
	           	<tr>
	               <td class="title title-width">
	               		<span>理由<span class="required">*</span></span>
	               </td>
	               <td>
	               		<textarea rows="5" cols="100" id="directorReason" name="directorReason" readonly="readonly" >${interventionOrderCustom.directorReason }</textarea>
	               </td>
				</tr>
	           	<tr>
	               <td class="title title-width">
	               ...
	               <td>
	               		<textarea rows="5" cols="100" id="directorRemarks" name="directorRemarks" readonly="readonly" >${interventionOrderCustom.directorRemarks }</textarea>
	               </td>
				</tr>
	        </table>
		</div>
	</c:if>
	<c:if test="${not empty mapMchtAppeal.mchtAppealInterventionProcess }">
		<div class="title-top">
			<div class="table-title">
				<span>商家申诉</span>
			</div>
	...
	<c:if test="${not empty interventionOrderCustom.winType }">
		<div class="title-top">
			...
			<table class="gridtable marT10 status-table">
	               ...
	               <td>
	               		<select id="clientResultReason" name="clientResultReason" disabled="disabled" style="width: 50%;">
	               ...
	               <td>
	               		<select id="mchtResultReason" name="mchtResultReason" disabled="disabled" style="width: 50%;">
	...
	<c:if test="${not empty interventionOrderCustom.recordOfCases }">
		<div class="title-top">
			<div class="table-title">
				<span>结案记录</span>
			</div>

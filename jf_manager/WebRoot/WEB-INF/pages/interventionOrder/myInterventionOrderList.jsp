...
<script type="text/javascript">
	...
	var listConfig = {
		url : "/interventionOrder/getInterventionOrderList.shtml?statusFlag=9",
		btnItems : [],
		listGrid : {
			columns : [
					...
					},
					{
						...
						render : function(rowdata, rowindex) {
							...
							return "<a href=\"javascript:showInterventionOrder("
									+ rowdata.id
									+ ", "
									+ statusPage
									+ ");\">查看</a>";
	...
	<form id="dataForm" runat="server">
					...
					<div class="search-td-combobox-condition">
						<select id="status" name="status" style="width: 135px;">
							...
							<c:forEach var="status" items="${statusList }">
								<c:if test="${status.statusValue == '1' or status.statusValue == '2' or status.statusValue == '5' 
									or status.statusValue == '7' or status.statusValue == '4' or status.statusValue == '6' }">
		...
		<div class="search-pannel">
			<div class="search-tr">
				...
				<div class="search-td">
					<div class="search-td-label" style="float:left;">申请介入日期：</div>
					<div class="l-panel-search-item">
						<input type="text" id="createDateStart" name="createDateStart" class="dateEditor" />
					</div>

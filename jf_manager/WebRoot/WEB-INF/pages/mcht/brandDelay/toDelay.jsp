...
$(function(){
	...
	$("#confirm").bind('click',function(){
		...
		submitting = true;
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/brandDelay/saveDelayDays.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
			data : {"mchtProductBrandId":mchtProductBrandId,"delayDays":delayDays},
			timeout : 30000,
	...
	<input type="hidden" id="mchtProductBrandId" value="${mchtProductBrandId}">
		<table class="gridtable">
          	<tr>
          		...
          		<td>
          			<select id="delayDays" name="delayDays" style="width: 140px;">

...
<body>
	<form method="post" id="form1" name="form1"
		...
		<input id="id" name="id" type="hidden" value="${xiaonengCustomerservicelist.id}" />
		<table class="gridtable">
			<tr>
				<td class="title">企业ID*</td>
				<td align="left" class="l-table-edit-td"><input id="busId" 
					name="busId" type="text" value="${xiaonengCustomerservicelist.busId}"
			...
			<td class="title">商家名称*</td>
				<td align="left" class="l-table-edit-td"><input id="mchtName" 
					name="mchtName" type="text" value="${xiaonengCustomerservicelist.mchtName}"
					style="float:left;width: 200px;" validate="{required:true,nameUnique:true}" />
				</td>
			</tr>
			<tr>
			<td class="title">客服代码*</td>
				<td align="left" class="l-table-edit-td"><input id="code" 
					name="code" type="text" value="${xiaonengCustomerservicelist.code}"
					style="float:left;width: 200px;" validate="{required:true,nameUnique:true}" />
				</td>
			</tr>
			<tr>
				...
				<input type="radio" name="status" value="0"  <c:if test="${xiaonengCustomerservicelist.status==0}">checked="checked"</c:if>>停用
                <input type="radio" name="status" value="1"  <c:if test="${xiaonengCustomerservicelist.status==1}">checked="checked"</c:if>>启用
                </td>
			</tr>

...
$(function(){
	$("#confirm").bind('click',function(){
		...
		var yearlyInspectionDate = $("#yearlyInspectionDate").val();
		submitting = true;
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/mchtInfoChg/saveYearlyInspectionDate.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
			data : {"id":id,"yearlyInspectionDate":yearlyInspectionDate},
			timeout : 30000,
...
<body>
	...
	<input type="hidden" id="mchtChgId" value="${id}">
		<table class="gridtable">
          	<tr>
          		<td class="title">营业执照有效期</td>
          		<td>
          			<input id="yearlyInspectionDate" name="yearlyInspectionDate" type="text" style="width:400px;" value="<fmt:formatDate value="${yearlyInspectionDate}" pattern="yyyy-MM-dd"/>"/>
					<script type="text/javascript">
						$(function() {

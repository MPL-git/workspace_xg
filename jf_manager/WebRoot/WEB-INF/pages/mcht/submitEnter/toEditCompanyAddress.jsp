...
$(function(){
	$("#confirm").bind('click',function(){
		...
		submitting = true;
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/saveCompanyAddress.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
...
<body>
	...
	<input type="hidden" id="mchtId" value="${id}">
		<table class="gridtable">
          	<tr>
          		<td class="title">公司住所</td>
          		<td>
          			<input type="text" id="companyAddress" name="companyAddress" value="${companyAddress}">
          		</td>
          	</tr>
	        <tr>

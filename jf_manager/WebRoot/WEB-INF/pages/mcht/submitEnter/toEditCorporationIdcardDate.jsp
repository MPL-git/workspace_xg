...
$(function(){
	$("#confirm").bind('click',function(){
		...
		submitting = true;
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/saveCorporationIdcardDate.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
	...
	<input type="hidden" id="mchtId" value="${id}">
		<table class="gridtable">
          	<tr>
          		...
          		<td>
          			<input id="corporationIdcardDate" name="corporationIdcardDate" type="text" style="width:400px;" value="<fmt:formatDate value="${corporationIdcardDate}" pattern="yyyy-MM-dd"/>"/>
					<script type="text/javascript">
						$(function() {
							$("#corporationIdcardDate").ligerDateEditor({
									showTime : false,
									labelWidth : 150,
									width:150,
									labelAlign : 'left'

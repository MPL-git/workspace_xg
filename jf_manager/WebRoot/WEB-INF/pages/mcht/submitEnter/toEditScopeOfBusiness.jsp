...
$(function(){
	...
	$("#confirm").bind('click',function(){
		...
		var id = $("#mchtId").val();
		var scopeOfBusiness = $("#scopeOfBusiness").val();
		if(scopeOfBusiness.length>1024){
			commUtil.alertError("经营范围字数不能超过1024");
			return;
		}
		submitting = true;
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/saveScopeOfBusiness.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
			data : {"id":id,"scopeOfBusiness":scopeOfBusiness},
			timeout : 30000,
	...
	<input type="hidden" id="mchtId" value="${id}">
		<table class="gridtable">
          	<tr>
          		...
          		<td>
          			<textarea rows="13" cols="83" id="scopeOfBusiness" name="scopeOfBusiness" maxlength="1024">${scopeOfBusiness}</textarea>
          		</td>
          	</tr>
	        <tr>

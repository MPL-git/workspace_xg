...
$(function(){
	$("#confirm").bind('click',function(){
		...
		submitting = true;
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/editZsTotalAuditStatus.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
			data : {"id":id,"zsTotalAuditStatus":zsTotalAuditStatus,"zsTotalAuditRemarks":zsTotalAuditRemarks},
			timeout : 30000,
...
<body>
	...
	<input type="hidden" id="mchtId" value="${mchtInfo.id}">
		<table class="gridtable">
          	<tr>
          		<td class="title">招商总审状态</td>
          		<td>
          			<select id="zsTotalAuditStatus" name="zsTotalAuditStatus">
          				<option value="4">未提审</option>
          	...
          	<tr>
          		...
          		<td>
          			<textarea rows="20" cols="80" id="zsTotalAuditRemarks" name="zsTotalAuditRemarks">${mchtInfo.zsTotalAuditRemarks}</textarea>
          		</td>
          	</tr>
	        <tr>

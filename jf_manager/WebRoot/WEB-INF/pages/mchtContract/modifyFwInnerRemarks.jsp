...
$(function(){
	$("#confirm").bind('click',function(){
		$.ajax({
			url : "${pageContext.request.contextPath}/mchtContract/modifyFwInnerRemark.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
...
<body>
	...
	<input type="hidden" id="id" name="id" value="${mchtContract.id}">
		<table class="gridtable">
          	<tr>
          		<td class="title">法务备注</td>
          		<td><textarea style="resize:none;" rows="7" cols="60" id="fw_innerRemarks" name="fwInnerRemarks" maxlength="256">${mchtContract.fwInnerRemarks}</textarea></td>
          	</tr>

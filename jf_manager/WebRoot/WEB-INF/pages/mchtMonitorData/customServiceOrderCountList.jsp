...
function getGridOptions(checkbox){
 ...
 var listConfig={
     url:"/mchtMonitorData/customServiceOrderCountList.shtml",
     listGrid:{ columns: [
			            ...
			            { display: '支付商品数量',width:150,render: function (rowdata, rowindex) {
			           		return '<span>'+rowdata.payOrderCount+'</span>';
		                }},
		                { display: '未发货商品数量',width:150, render: function (rowdata, rowindex) {
		               		return '<span>'+rowdata.deliveryCount+'</span>';
		                }},
		                { display: '退款商品数量',width:150, render: function (rowdata, rowindex) {
		                	return '<span>'+rowdata.refundOrderCount+'</span>';
		                }},
		                { display: '退款率',width:150, render: function (rowdata, rowindex) {
							return formatMoney(rowdata.refundAmountRate,2)+"%";
		                }},
		                { display: '退货商品数量',width:150, render: function (rowdata, rowindex) {
		                	return '<span>'+rowdata.returnBillCount+'</span>';
		                }},
		                { display: '退货率',width:150, render: function (rowdata, rowindex) {
							return formatMoney(rowdata.refundbillRate,2)+"%";
		                }},
		                { display: '换货商品数量',width:150, render: function (rowdata, rowindex) {
		                	return '<span>'+rowdata.swapOrderCount+'</span>';
		                }},

	...
	<form method="post" id="form1" name="form1">
		<table class="gridtable" style="width:1200px;">
			...
			<tr>
				...
				<td>
					<fmt:formatDate value="${mchtShopDynamic.auditDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
			</tr>
			<tr>
				<td class="title">审核结果</td>
				<td>
					<c:if test="${mchtShopDynamic.auditStatus eq 1}">通过</c:if>
					<c:if test="${mchtShopDynamic.auditStatus eq 2}">拒绝</c:if>
				</td>
			</tr>
			<tr>
				<td class="title">驳回理由*</td>
				<td style="word-break: break-all;">
					${mchtShopDynamic.rejectionReason}
				</td>
			</tr>
			</tbody>
		</table>

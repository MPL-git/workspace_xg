	...
	<div>
		<table class="gridtable">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<input type="text" id="integral" name="integral" style="float:left;width: 150px" value="${integralGiveCustom.integral }" disabled="disabled" />
					<span>个</span>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<textarea rows=3 id="remarks" name="remarks" cols="45" class="text" disabled="disabled" >${integralGiveCustom.remarks }</textarea>
				</td> 
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<c:forEach var="costBearItem" items="${costBearList }">
						<span class="radioClass">
							<input name="costBear" <c:if test="${integralGiveCustom.costBear == costBearItem.statusValue }">checked</c:if> disabled="disabled" type="radio" value="${costBearItem.statusValue }" style="width: 30px;" >
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
					<c:forEach var="isDepositDeductItem" items="${isDepositDeductList }">
						<input name="isDepositDeduct" <c:if test="${integralGiveCustom.isDepositDeduct == isDepositDeductItem.statusValue }">checked</c:if> disabled="disabled" type="radio" value="${isDepositDeductItem.statusValue }" style="width: 30px;"/>

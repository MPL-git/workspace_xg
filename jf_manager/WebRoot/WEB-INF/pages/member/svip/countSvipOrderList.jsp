...
<script type="text/javascript">
	...
	function combineList(payDate,paymentId) {
		$.ligerDialog.open({
			...
			title: "年费收款明细",
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/svipOrder/financeSvipOrderManager.shtml?paymentId=" + paymentId+"&payDate="+payDate,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
	...
	//导出
	function excel(){  
		$("#dataForm").attr("action","${pageContext.request.contextPath}/svipOrder/exportCountSvipOrderList.shtml");
		$("#dataForm").submit();
	}
	
    var listConfig={
	  url:"/svipOrder/countSvipOrderList.shtml",

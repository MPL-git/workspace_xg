...
<head>
 ...
 <script type="text/javascript">
	 ...
	 function viewDetail(id) {
 	 ...
 	 var listConfig={
	      url:"/memberLabelRelation/getMemberLabelRelationList.shtml",
	      btnItems:[],
	      listGrid:{ columns: [
							{display:'会员ID',name:'memberId', align:'center', isSort:false, width:100},
							{display:'会员昵称',name:'memberNick', align:'center', isSort:false, width:100},
							{display:'会员状态',name:'memberStatusDesc', align:'center', isSort:false, width:100},
...
<body style="padding: 0px; overflow: hidden;">
	...
	<form id="dataForm" runat="server">
		<div class="search-pannel">
			<input type="hidden" id="labelGroupId" name="labelGroupId" value="${labelGroupId }" >
			<div class="search-tr" > 
				<div class="search-td">
				...
				<div class="search-td" style="width: 40%;">
					...
					<div class="l-panel-search-item" >
						<input type="text" id="startCreateDate" name="startCreateDate" class="dateEditor" style="width: 135px;" />
					</div>

  ...
  var listConfig={
      ...
      listGrid:{ columns: [{ display: "母订单号", width: "10%",render: function(rowdata, rowindex) {
		                ...
		                { display: '操作',render: function (rowdata, rowindex) {
		                	if(rowdata.status == "1" && ${sessionScope.USER_SESSION.staffID} == 1 ){//已退
...
<body style="padding: 0px; overflow: hidden;">
	...
	<form id="dataForm" runat="server">
		...
		<div class="search-tr"  > 
			...
			<div class="search-td">
			<div class="search-td-label" style="float: left;width: 25%;margin-top:2px;">退款日期：</div>
			<div class="l-panel-search-item" >

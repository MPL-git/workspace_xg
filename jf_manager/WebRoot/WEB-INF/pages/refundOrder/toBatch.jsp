...
$(function(){
		$("#confirm").bind('click',function(){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/refundOrder/batch.shtml",
				type : 'POST',
				dataType : 'json',
				cache : false,
				async : false,
				data : {"ids":refundOrderId,status:status,refundRegisterDate:refundRegisterDate,refundCode:refundCode},
				timeout : 30000,
...
<html>
<body>
<form method="post" id="form" name="form" action="${pageContext.request.contextPath}/refundOrder/batch.shtml">
			<input type="hidden" id="refundOrderId" value="${ids}">
			<table class="gridtable">
           	<tr>
               <td class="title">更改状态</td>
               <td colspan="2" align="left" class="l-table-edit-td">
	               <input type="radio" name="status" value="3"/>登记&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	               <input type="radio" name="status" value="4"/>确认
               </td>
			</tr>
	        <tr>

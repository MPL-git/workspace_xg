...
<script type="text/javascript">
	...
	function addproduct(id,sourceType) {
		$("input[type=button]").attr('disabled',true);
		$.ajax({
			type: 'post',
			url: '${pageContext.request.contextPath}/resourceLocationManagement/addProductlist.shtml',
 ...
 var listConfig={
      url:"/resourceLocationManagement/administrationCommoditydata.shtml",
      ...
      listGrid:{ columns: [
			            ...
			            { display: '品牌/货号', width: 180, render: function (rowdata, rowindex) {
			            	var html=[];
 		                	...
 		                	if (productBrandName!=null || artNo!=null){
 		                		html.push(productBrandName+"/"+artNo);
 		                	}
 		                	return html.join("");
		                }},
		                ...
		                { display: '吊牌价/商城价/活动价', name: '', width: 200, render: function(rowdata, rowindex) {
                         /*     var html = [];
			         ...
			         { display: "操作", name: "OPER", width: 100, align: "center", render: function(rowdata, rowindex) {
							var html = [];
							html.push("<input type='button' style='width:70px;margin-top:5px;' name='' onclick='addproduct(" + rowdata.id + ",${sourceType})' value='添加'>");
							return html.join("");
					 }},

...
$(function(){
  ...
  var listConfig={
	  ...
	  url:"/resourceLocationManagement/getCategoryProductDataStatisticsList.shtml?pagetype="+${pagetype},
      
      listGrid:{ columns: [
      					{ display: "类目", name:'name'},
...
<body style="padding: 0px; overflow: hidden;">
	...
	<form id="dataForm" runat="server">
		...
		<div class="search-tr"  >
			...
			<div class="search-td" style="width:230px;margin-bottom:-5px;">
			<div class="l-panel-search-item">
				<script type="text/javascript">
					$(function() {

  ...
  <head>
    ...
    <link href="${pageContext.request.contextPath}/css/search_form.css" rel="stylesheet" type="text/css" />
     ...
     <script type="text/javascript">
	    ...
	    var listConfig={
    	      url:"/androidSpreadActivityGroup/data.shtml",
    	      btnItems:[
    	                { text: '添加', icon: 'add', dtype:'win',  click: itemclick, url:"/spread/editSpreadActivityGroup.shtml?deviceType=2", seqId:"", width : 600, height:400},
	    ...
	    function batchEditSpreadActivityGroup() {
             ...
             var str = "";
	   		...
	   		$.ligerDialog.open({
		   		...
		   		title: "修改活动组",
		   		name: "INSERT_WINDOW",
		   		url: "${pageContext.request.contextPath}/spread/batchEditSpreadActivityGroup.shtml?deviceType=2&spreadActivityGroupIds="+str,
		   		showMax: true,
		   		showToggle: false,
		   		showMin: false,
		   		isResize: true,
	    ...
	    function editSpreadActivityGroup(id) {
		   	$.ligerDialog.open({
		   		...
		   		title: "修改活动组",
		   		name: "INSERT_WINDOW",
		   		url: "${pageContext.request.contextPath}/spread/editSpreadActivityGroup.shtml?deviceType=2&id=" + id,
		   		showMax: true,
		   		showToggle: false,
		   		showMin: false,
		   		isResize: true,
		...
		function updateDiscountRateBatch() {
			$.ligerDialog.open({
				...
				title: "批量修改优惠率",
				name: "INSERT_WINDOW",
				url: "${pageContext.request.contextPath}/spread/updateDiscountRateBatchManager.shtml?deviceType=2",
				showMax: true,
				showToggle: false,
				showMin: false,
				isResize: true,

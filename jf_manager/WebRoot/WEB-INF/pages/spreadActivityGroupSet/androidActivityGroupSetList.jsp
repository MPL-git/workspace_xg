...
<head>
 ...
 function editSpreadActivityGroupSet(id, title) {
	 $.ligerDialog.open({
			...
			title: title,
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/spreadActivityGroupSet/editSpreadActivityGroupSetManager.shtml?deviceType=2&id="+id,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
 ...
 var listConfig={
     ...
     url:"/androidActivityGroupSet/data.shtml",
     listGrid:{ columns: [

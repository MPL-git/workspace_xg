 ...
 <script type="text/javascript">
	...
	function fwAudit(id) {
		$.ligerDialog.open({
			...
			title: "法务审核",
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/task/taskAudit.shtml?type=2&Id=" + id ,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
 	...
 	var listConfig={
	      ...
	      listGrid:{ columns: [
	                        ...
	                        {display:'操作', name:'', align:'center', isSort:false, width:180, render: function(rowdata, rowindex) {
								var html = [];
								if(rowdata.status == "2"){
									html.push("<a href=\"javascript:fwAudit(" + rowdata.id + ");\">法务审核</a>&nbsp;&nbsp;");
				...
				<div class="search-td">
					...
					<div class="search-td-combobox-condition" >
						<select id="status" name="status" style="width: 70%;">
							...
							<option value="2" selected>待法务审核</option>

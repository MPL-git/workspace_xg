 ...
 <script type="text/javascript">
	...
	function viewTaskSms(taskSmsId) {
	 ...
	 function auditTask(taskId, taskStatus) {
		 $.ligerDialog.confirm("是否确定恢复任务？", function (status){  
            if(status==true){
           	 $.ajax({
       			 type: 'post',
 	 ...
 	 var listConfig={
	      ...
	      listGrid:{ columns: [
							...
							{display:'预估条数',name:'sendCount', align:'center', isSort:false, width:80},
							...
							{display:'操作',name:'', align:'center', isSort:false, width:100, render:function(rowdata,rowindex){
								var html = [];
								html.push("<a href=\"javascript:auditTask(" + rowdata.taskId + ", 0);\">【恢复任务】</a>");
								return html.join("");
							}}
			         ], 

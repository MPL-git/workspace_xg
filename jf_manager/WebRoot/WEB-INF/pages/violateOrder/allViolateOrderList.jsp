...
function viewViolateOrder(id) {
 ...
 var listConfig={
     ...
     url:"/violateOrder/allViolateOrderData.shtml",
     listGrid:{ columns: [
		                ...
		                { display: '平台处理人', render: function (rowdata, rowindex) {
	...
	<form id="dataForm" runat="server" method="post">
		...
		<div class="search-tr"  > 
			...
			<div class="l-panel-search-item" >
				<select id="orderSource" name="orderSource" style="width: 150px;" >
		...
		<div class="search-tr"  >	
			...
			<div class="search-td">
			<div class="search-td-label" style="float:left;">积分状态：</div>
			<div class="l-panel-search-item" >
				<select id="jifenStatus" name="jifenStatus" style="width: 150px;" >
					<option value="">请选择</option>
					<c:forEach var="jifenStatus" items="${jifenStatusList}">
						<option value="${jifenStatus.statusValue}">${jifenStatus.statusDesc}</option>
					</c:forEach>
				</select>
		 	 </div>
			 </div>
		...
		<div class="search-tr"  >
			...
			<div class="search-td">
			<div class="search-td-label" style="float:left;">申诉日期：</div>
			<div class="l-panel-search-item" >
				<input type="text" id="complain_date_begin" name="complain_date_begin" />
				<script type="text/javascript">
					$(function() {
			...
			<div class="search-tr">
				...
				<div class="search-td">
			 	<div class="search-td-label" >平台处理人：</div>
			 	<div class="search-td-condition" >
				<select id="platformProcessor" name="platformProcessor" class="querysel">
					<option value="">请选择...</option>
					<c:forEach var="getplatformProcessorList" items="${getplatformProcessorList}">
					   <option value="${getplatformProcessorList.platform_processor}">${getplatformProcessorList.staff_name}</option>
				   </c:forEach>					
				</select>
				</div>
		 	  </div>

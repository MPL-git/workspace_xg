...
public class CaptchaUtils {
	...
	public static String getRandomChar() {
		...
		case 1:
			...
			ctmp = (char) itmp;
			if(!String.valueOf(ctmp).equals("L") && !String.valueOf(ctmp).equals("I") 
					&& !String.valueOf(ctmp).equals("O") && !String.valueOf(ctmp).equals("Q")
					&& !String.valueOf(ctmp).equals("G") && !String.valueOf(ctmp).equals("Z") )

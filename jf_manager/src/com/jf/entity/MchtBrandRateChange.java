...
public class MchtBrandRateChange {
    ...
    private BigDecimal prePopCommissionRate;
    ...
    public BigDecimal getPrePopCommissionRate() {
        return prePopCommissionRate;
    }

    public void setPrePopCommissionRate(BigDecimal prePopCommissionRate) {
        this.prePopCommissionRate = prePopCommissionRate;
    }

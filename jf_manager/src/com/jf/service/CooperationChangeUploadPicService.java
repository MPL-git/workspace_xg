...
import com.jf.dao.CooperationChangeUploadPicCustomMapper;
...
public class CooperationChangeUploadPicService extends BaseService<CooperationChangeUploadPic,CooperationChangeUploadPicExample>{
    ...
    @Autowired
    private CooperationChangeUploadPicCustomMapper customDao;
    ...
    public List<CooperationChangeUploadPic> selectCustomByExample(CooperationChangeUploadPicExample example){
        return dao.selectByExample(example);
    }

    public int updateByCooperationChangeApplyIdSelective(CooperationChangeUploadPic record){
        return customDao.updateByCooperationChangeApplyIdSelective(record);
    }

...
<head>
 ...
 .l-grid-body2{height:675px!important;}
 </style>
...
/* 查看活动 */
function cooSeeSingleProductInfo(activityProductId,productId) {
		$.ligerDialog.open({
...
/* 权限控制*/
function cooSeeSingleProductAudit(activityId) {
		$.ligerDialog.open({
		height: 800,
		width: 600,
		title: "单品活动商家权限管理",
 ...
 var listConfig={
		      ...
		      btnItems: [{ text: '重置商家报名状态', icon: 'settings', id:'add', dtype:'win', click: itemclick, url:"/activity/singleActivityStatusReset.shtml", width: 400, height: 300 },
		                 { line:true }, 
		                 { text: '从活动中剔除商品', icon: 'settings', id:'add', dtype:'win', click: itemclick, url:"/activity/singleActivityProductQuit.shtml", width: 400, height: 300 }
		                ],
		      listGrid:{ columns: [
...
/* 		                        {display:'类目/品牌',name:'typeBrandName',width: 200,render:function(rowdata,rowindex){
		                        ...
		                        {display:'审核状态',name:'cooAuditStatusDesc',width: 100,render:function(rowdata, rowindex){
		                        ...
		                        {display:'最后审核时间',name:'updateDate',width: 150,render:function(rowdata, rowindex){
		                        	if(rowdata.updateDate==null||rowdata.activityUpdateDate==""||rowdata.updateDate==undefined){
										return "";
									}else{
		                        ...
		                        { display: "操作", name: "OPER",align: "center",width: 150, render: function(rowdata, rowindex) {
										var html = [];
									    html.push("<a href=\"javascript:cooSeeSingleProductInfo(" + rowdata.id + ","+rowdata.productId+");\">查看</a>&nbsp;&nbsp;"); 
									    html.push("<a href=\"javascript:cooSeeSingleProductAudit(" + rowdata.activityId + ");\">权限管理</a>&nbsp;&nbsp;"); 
									    return html.join("");
							 		}
			             		},
 ...
 function rejectOnclick(){
	...
	function cooSingleTypeNameOnblur(){
			...
			<div class="search-tr">	
				...
				<div class="search-td-combobox-condition" >
				 ...
				 <div class="search-td">
					...
					<div class="search-td-combobox-condition">
						<select id="activityType" name="activityType" onchange="cooSingleTypeNameOnblur();" >
...
<!-- 				<div class="search-td">
					...
					<div class="search-td-combobox-condition" >
						<select id="typeName" name="typeName">s
							<option value="-1">不限</option>
						</select>
					</div>
				</div> -->

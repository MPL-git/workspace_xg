...
$(function(){
		$("#confirm").bind('click',function(){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/appMng/adMng/saveThemePavilions.shtml",
				type : 'POST',
				dataType : 'json',
				cache : false,
				async : false,
				data : {"id":id,remarks:remarks,autoUpDate:autoUpDate,autoDownDate:autoDownDate,positionFlag:positionFlag},
				timeout : 30000,
...
<html>
<body>
<form method="post" id="form" name="form" action="${pageContext.request.contextPath}/appMng/adMng/saveThemePavilions.shtml">
			<input type="hidden" id="id" name="id" value="${id}">
			<input type="hidden" id="positionFlag" name="positionFlag" value="${positionFlag}">
			<table class="gridtable">
           	<tr>
               <td class="title">主题名称</td>
               <td colspan="2" align="left" class="l-table-edit-td">
               		<input type="text" id="remarks" name="remarks" value="${adInfo.remarks}" style="width: 200px;"/>
               </td>
			</tr>
	        <tr>

...
<script type="text/javascript">
	...
	<form name="form1" class="form1" method="post" id="form1" action="${pageContext.request.contextPath}/appMng/version/editUpdateBy.shtml" >
		<input type="hidden" id="ids" name="ids" value="${ids }" />
		<table class="gridtable">
           	<tr>
           	    <td class="title" width="20%">变更处理人<span class="required">*</span></td>
				<td align="left" class="l-table-edit-td" >
	              	<select id="procesby" name="procesby" style="width: 135px;">

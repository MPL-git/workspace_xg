...
$(function(){
	$("#export").bind('click',function(){
		...
		location.href="${pageContext.request.contextPath}/combineDepositOrderCount/refundOrder/count/export.shtml?success_date_begin="+success_date_begin+"&success_date_end="+success_date_end;
	});
...
function refundList(successDate,paymentId) {
	$.ligerDialog.open({
		...
		title: "退款任务",
		name: "INSERT_WINDOW",
		url: "${pageContext.request.contextPath}/combineDepositOrderCount/refundOrder/list.shtml?paymentId=" + paymentId+"&successDate="+successDate,
		showMax: true,
		showToggle: false,
		showMin: false,
		isResize: true,
...
function toLockDate(lockDate) {
  ...
  var listConfig={
	  ...
	  url:"/combineDepositOrderCount/refundOrder/count/data.shtml",

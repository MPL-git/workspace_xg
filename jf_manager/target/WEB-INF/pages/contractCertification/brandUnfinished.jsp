...
<form id="dataForm" runat="server">
    <input type="hidden" name="mchtBrandArchiveStatus" value="0">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#export").bind('click', function () {
            ...
            location.href = "${pageContext.request.contextPath}/contractCertification/brandUnfinished/export.shtml?" + params;
        });
    });
</script>
</body>

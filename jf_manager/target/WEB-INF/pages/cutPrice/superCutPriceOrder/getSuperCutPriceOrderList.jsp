	...
	function viewProduct(id) {
	 ...
	 function addBlackList(memberId) { 
		 $.ligerDialog.open({
				...
				title: "拉黑",
				name: "INSERT_WINDOW",
				url: "${pageContext.request.contextPath}/superCutPriceOrder/addblackListManager.shtml?memberId="+memberId,
				showMax: true,
				showToggle: false,
				showMin: false,
				isResize: true,
	 ...
	 function showCutPriceOrderDtl(cutPriceOrderId) {
		 $.ligerDialog.open({
				...
				title: "助力详情",
				name: "INSERT_WINDOW",
				url: "${pageContext.request.contextPath}/superCutPriceOrder/superCutPriceOrderDtlManager.shtml?cutPriceOrderId="+cutPriceOrderId,
				showMax: true,
				showToggle: false,
				showMin: false,
				isResize: true,
	 ...
	 function updateAuditStatus(ids, auditStatus) {
 	 ...
 	 var listConfig={
	      url:"/superCutPriceOrder/getSuperCutPriceOrderList.shtml",
	      btnItems:[
	      ...
	      listGrid:{ columns: [
							{display:'邀请编号',name:'orderCode', align:'center', isSort:false, width:180},
	                        ...
	                        {display:'此次邀请次数',name:'cutPriceOrderDtlCount', align:'center', isSort:false, width:100},
							...
							{display:'参与邀请享免单次数',name:'superCutPriceOrderCount', align:'center', isSort:false, width:120},
							{display:'累计邀请次数',name:'superCutPriceOrderSuccCount', align:'center', isSort:false, width:100},
							{display:'操作',name:'', align:'center', isSort:false, width:220, render: function(rowdata, rowindex) {
								...
								html.push("<a href='javascript:;' onclick='showCutPriceOrderDtl("+rowdata.id+");'>【邀请记录】</a>");
							    return html.join("");
							}}
			         ], 
...
<body style="padding: 0px; overflow: hidden;">
	...
	<form id="dataForm" runat="server" >
		<div class="search-pannel">
			<div class="search-tr"  >
				<div class="search-td">
					<div class="search-td-label"  >邀请编号：</div>
				...
				<div class="search-td" style="width: 40%;">
					<div class="search-td-label" style="float: left;width: 20%;">邀请时间：</div>
			...
			<div class="search-tr"  >
				<div class="search-td">
					<div class="search-td-label"  >邀请状态：</div>
					<div class="search-td-combobox-condition" >

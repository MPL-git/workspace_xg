...
<script type="text/javascript">
	...
	<form name="form1" class="form1" method="post" id="form1" action="${pageContext.request.contextPath}/superCutPriceProduct/updateAuditStatus.shtml" >
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" >
					<span style="margin-left: 10px;">
						<label>
							<input type="radio" name="type" value="8" checked="checked" />超级砍价
						</label>
					</span>
				</td>
           	</tr>

...
<head>
 ...
 function updateSeqNo(id) {
	...
	if(seqNo != '' && flag != null) {
		$.ajax({
			 type : 'POST',
			 url : "${pageContext.request.contextPath}/androidChannelGroupSet/updateSeqNo.shtml",
 ...
 // 编辑
 function editAndroidChannelGroupSet(id, title) {
	 $.ligerDialog.open({
		 	height: $(window).height()-50,
			width: $(window).width()-50,
			title: title,
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/androidChannelGroupSet/editAndroidChannelGroupSetManager.shtml?id="+id,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
 ...
 var listConfig={
	 btnItems:[{text:'添加', icon:'add', click: function() {
	 		editAndroidChannelGroupSet('', '添加');
        }}
	 ],
     url:"/androidChannelGroupSet/androidChannelGroupSetList.shtml",
     listGrid:{ columns: [
			...
			{ display: '安卓渠道组', name:'name', align:'center', isSort:false, width:180},
            ...
            { display: '操作', name:'', align:'center', isSort:false, width:80, render: function(rowdata, rowindex) {
				return "<a href='javascript:;' onclick='editAndroidChannelGroupSet("+rowdata.id+", \"编辑\");'>【编辑】</a>";
			}}
            ],
...
<body style="padding: 0px; overflow: hidden;">
	...
	<form id="dataForm" runat="server">
		<div class="search-pannel">
			<div class="search-tr">
				<div class="search-td">
					<div class="search-td-label">安卓渠道组：</div>

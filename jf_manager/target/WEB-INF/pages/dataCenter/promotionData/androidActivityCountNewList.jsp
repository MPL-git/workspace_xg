...
<head>
 ...
 $(function(){
	...
	$("#searchbtn2").bind('click',function(){
		...
		var activityGroupId = $("#activityGroupId").val();
		if(!channel){
		...
		$("[name='channelName']").val($("#activityGroupId").find("option:selected").text());
	});	
 });
 ...
 var listConfig={
     url:"/promotionData/androidActivityCountNew/data.shtml",
  	 btnItems:[
     ...
     listGrid:{ columns: [
		                ...
		                { display: '活动组', width: 300, render: function (rowdata, rowindex) {
		                	if (rowdata.total_consumption==null){
								return "<span style='color:#F00;'>"+rowdata.spreadname+"</span>";	
		                	}else{
		                		return rowdata.spreadname;
		                	}
		                }},
			...
			<div class="search-tr">
				...
				<div class="search-td">
					<div class="search-td-label">
						<span style="color: #FF0000;font-weight: bold;">*</span>活动组：
					</div>
					<div class="search-td-combobox-condition">
				...
				<div class="search-td" style="width: 40%;">
					...
					<div class="l-panel-search-item">
						<input type="text" id="order_date_begin" name="order_date_begin" value="" class="dateEditor" />
					</div>
					<div class="l-panel-search-item" style="margin-left: 15px;margin-right: 15px;" >至</div>
					<div class="l-panel-search-item">
						<input type="text" id="order_date_end" name="order_date_end" value="" class="dateEditor" />
					</div>
				</div>
			</div>
			<div class="search-tr">

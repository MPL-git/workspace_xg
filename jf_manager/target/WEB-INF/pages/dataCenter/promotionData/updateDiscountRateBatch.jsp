...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			liger.get("listbox2").setData(${androidChannelGroupJson});
			...
			$("#form1").validate({
				...
				submitHandler: function(form) {
					var ids = liger.get("listbox1").data;
					if(ids != null && ids.length > 0 ) {
						var id = "";
						for (var i=0;i<ids.length;i++) {
							id = id+","+ids[i].id;
						}
						$("#ids").val(id.substring(1));
					}else {
...
<form name="form1" class="form1" method="post" id="form1" action="${pageContext.request.contextPath}/promotionData/spreadChannelData/updateDiscountRateBatch.shtml" >
	<table class="gridtable">
		<tr>
			<td class="title">渠道集合名称<span class="required">*</span></td>
			<td align="left" class="l-table-edit-td">
				...
				</div>androidChannelGroupDiscountRate/selectAndroidChannelGroupDiscountRateList.shtml
			</td>
		</tr>
		<tr>

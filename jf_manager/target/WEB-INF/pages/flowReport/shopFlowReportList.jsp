   ...
   /*         $(".l-dialog-close").live("click", function(){
                    ...
                    success : function(data) {
                        if ("0000" == data.returnCode) {
                            ...
                            $.ligerDialog.open({
                                ...
                                title: title,
                                name: "INSERT_WINDOW",
                                url: "${pageContext.request.contextPath}/flowReport/shopProductShow.shtml?id="+id+"&reportColumnId="+reportColumnId+"&type=1"+"&payBegin="+payBegin+"&payEnd="+payEnd,
                                showMax: true,
                                showToggle: false,
                                showMin: false,
                                isResize: true,
                ...
                success : function(data) {
                    if ("0000" == data.returnCode) {
                        ...
                        $.ligerDialog.open({
                            ...
                            title: title,
                            name: "INSERT_WINDOW",
                            url: "${pageContext.request.contextPath}/flowReport/shopBrandShow.shtml?id="+id+"&reportColumnId="+reportColumnId+"&type=1"+"&payBegin="+payBegin+"&payEnd="+payEnd,
                            showMax: true,
                            showToggle: false,
                            showMin: false,
                            isResize: true,
        ...
        function getVisitorCount(flagId, payBegin,payEnd) {
            ...
            $.ajax({
                ...
                data: {type:"mcht",reportColumnId : reportColumnId,productTypeId : productTypeId, flagId : flagId, payBegin : payBegin,payEnd:payEnd},
                dataType: 'json',
                success: function(data) {
        ...
        var listConfig={
            url:"/flowReport/shopFlowReportData.shtml",
            listGrid:{ columns: [
                    ...
                    {display:'操作',name:'', align:'center', isSort:false, width:160, render: function(rowdata, rowindex) {
                            var html = [];
                            html.push("<a href='javascript:;' onclick='showProduct("+rowdata.mchtId+",\""+rowdata.shopName+"\");'>查看商品</a>&nbsp&nbsp");
                            html.push("<a href='javascript:;' onclick='showBrand("+rowdata.mchtId+",\""+rowdata.shopName+"\")'>查看品牌</a>");
                            return html.join("");
                        }},
        ...
        <div class="search-tr">
            <div class="search-td">
                ...
                <div class="search-td-condition">
                    <input id="mchtCode"  name="mchtCode"/>
                </div>
            </div>
            ...
            <div class="search-td">
                ...
                <div class="search-td-condition">
                    <input id="mchtName" name="mchtName">
                </div>
            </div>

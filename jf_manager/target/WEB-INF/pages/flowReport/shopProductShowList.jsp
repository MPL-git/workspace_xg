...
<head>
  ...
  /*          $(".l-dialog-close").live("click", function(){
        ...
        var listConfig={
            url:"/flowReport/shopProductShowData.shtml?id=${id}&type=${type}&reportColumnId=${reportColumnId}",
            listGrid:{ columns: [
                    { display: '商品',name:'productCode',width:120},
                    {display:'商品主图/名称', name:'seqNo', align:'center', isSort:false, width:250, render:function(rowdata, rowindex) {
                            ...
                            html.push(h);
                            html.push("<div class='width-226'><p class='ellipsis'>"+rowdata.name+"</p></div>")
                            html.push("<div>")

...
<head>
    <script type="text/javascript">
        ...
        function getVisitorCount(flagId, payBegin,payEnd) {
            ...
            var innerBrandId = $("#innerBrandId").val();
            var innerTypeId = $("#innerTypeId").val();
            $.ajax({
                type: 'post',
                url: '${pageContext.request.contextPath }/flowReport/getVisitorCount.shtml',
                data: {type:"mcht",reportColumnId : reportColumnId, productBrandId:innerBrandId,productTypeId : innerTypeId, flagId : flagId, payBegin : payBegin,payEnd:payEnd},
                dataType: 'json',
                success: function(data) {
        ...
        var listConfig={
            url:"/flowReport/shopShowData.shtml?id=${id}&type=${type}&reportColumnId=${reportColumnId}",
            listGrid:{ columns: [
...
<form id="dataForm" runat="server">
    <input type="hidden" id="innerBrandId" name="innerBrandId" value="${innerBrandId}" />
    ...
    <div class="search-pannel">
        ...
        <div class="search-tr">
            ...
            <div class="search-td">
                ...
                <div class="search-td-condition">
                    <input id="productCode"  name="mchtCode"/>
                </div>
            </div>
        ...
        <div class="search-tr">
            ...
            <div class="search-td">
                ...
                <div class="search-td-condition">
                    <input id="productName" name="mchtName">
                </div>
            </div>

...
<script type="text/javascript">
	...
	<form name="form1" class="form1" method="post" id="form1" action="${pageContext.request.contextPath}/spreadActivityGroupDiscountRate/addSpreadActivityGroupDiscountRate.shtml" >
				...
				<td align="left" class="l-table-edit-td" >
					<select id="groupNameId" name="groupNameId" style="width: 160px;" onchange="updateDiscountRate();" >
						...
						<c:forEach var="spreadActivityGroup" items="${spreadActivityGroupList }">
							<option value="${spreadActivityGroup.id }" rate="${spreadActivityGroup.discountRate}" >${spreadActivityGroup.activityGroup }</option>
						</c:forEach>
					</select>
				</td>
           	</tr>

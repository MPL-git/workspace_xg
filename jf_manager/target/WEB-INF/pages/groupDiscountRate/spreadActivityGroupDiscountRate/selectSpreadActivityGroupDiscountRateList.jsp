 ...
 <script type="text/javascript">
	 ...
	 function updateDiscountRateBatch() {
		 $.ligerDialog.open({
			...
			title: "批量修改优惠率",
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/spreadActivityGroupDiscountRate/updateDiscountRateBatchManager.shtml?deviceType=1",
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
	 ...
	 function addSpreadActivityGroupDiscountRate() {
		 $.ligerDialog.open({
			 ...
			 title: "新增渠道优惠率",
			 name: "INSERT_WINDOW",
			 url: "${pageContext.request.contextPath}/spreadActivityGroupDiscountRate/addSpreadActivityGroupDiscountRateManager.shtml?deviceType=1",
			 showMax: true,
			 showToggle: false,
			 showMin: false,
			 isResize: true,
 	 ...
 	 var listConfig={
	      url:"/spreadActivityGroupDiscountRate/selectSpreadActivityGroupDiscountRateList.shtml",

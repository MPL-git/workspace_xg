...
$(function ()  { 
   ...
   $("#form1").validate({
	...
	<form method="post" id="form1" name="form1"  action="${pageContext.request.contextPath}/interventionOrder/addinterventionOrderWorklist.shtml" >
		...
		<input type="hidden" id="id" name="id" value="${interventionOrderCustom.id}"/>
		<table class="gridtable">
				<tr>
	           	...
	           	<tr>
					...
					<td align="left" class="l-table-edit-td" >
						<select style="width: 135px;" id="relevantType" name="relevantType" >
							<option value=''>请选择...</option>
				            <option value='1' selected>介入单</option>
	           	...
	           	<tr>	       
					...
					<td align="left" class="l-table-edit-td" >
						<input style="width:360px;" type="text" id="relevantCode" name="relevantCode" value="${interventionOrderCustom.interventionCode}" />
					</td>
	           	</tr>

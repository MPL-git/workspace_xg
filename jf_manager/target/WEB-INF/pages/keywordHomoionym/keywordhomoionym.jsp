...
<html>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/common/js/ligerLinkageComboBox.js"></script>
	...
	function edit(id) {
		$.ligerDialog.open({
			...
			title: "编辑",
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/keywordHomoionym/edit.shtml?Id=" + id ,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,
	...
	function delFavorites(id) {
		...
		{ 
			if(yes){
				$.ajax({
					url : "${pageContext.request.contextPath}/keywordHomoionym/updatekeywordHomoionymdata.shtml?id=" + id,
					secureuri : false,
					dataType : 'json',
					cache : false,
					async : false,
	 ...
	 var listConfig={
		     url:"/keywordHomoionym/keywordhomoionymdata.shtml",
		     btnItems:[{ text: '添加', icon: 'add', id:'add', dtype:'win', click: itemclick, url:"/keywordHomoionym/edit.shtml", seqId:"", width: 750, height: 450}],
		     listGrid:{ columns: [
								{ display: '关键字', name:'keyword',width: 200},
								{ display: '近义词', name:'homoionym',width: 200},
  ...
  <div class="l-loading" style="display: block" id="pageloading"></div>
	...
	<form id="dataForm" runat="server">
		...
		<div class="search-tr" > 
			<div class="search-td">
			<div class="search-td-label" style="float:left;">关键字：</div>

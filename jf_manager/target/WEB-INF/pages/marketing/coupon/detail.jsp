...
<script type="text/javascript">
    ...
    var listConfig={
      ...
      url:"/marketing/coupon/dataDetail.shtml",
      listGrid:{ columns: [
		                { display: '优惠劵名称', name: 'couponName'},
		                { display: '优惠劵额度', render: function(rowdata, rowindex) {
		                	return usingDetail;
		                }},
		                { display: '会员昵称', name: 'nick'},
		                { display: '会员手机号', name: 'mobile'},
		                ...
		                { display: '优惠劵状态', name: 'statusDesc'},
		                { display: '订单号', name: 'combineOrderCode'}
		                ],   

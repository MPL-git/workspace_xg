...
$(function(){
	...
	$("#confirm").bind('click',function(){
		...
		submitting = true;
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/close/saveMchtCloseApplyRemarks.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
			data : {"id":id,"remarks":remarks,"progressStatus":progressStatus},
			timeout : 30000,
			success : function(data) {
				if(data.returnCode == '0000'){
					...
					setTimeout(function(){
						window.parent.updateRemark(id,remarks);
...
<body>
	...
	<input type="hidden" id="progressStatus" value="${progressStatus}">
		<table class="gridtable">
          	<tr>
          		<td class="title">备注</td>
          		<td>
          			<textarea rows="15" cols="50" id="remarks" name="remarks" maxlength="256"></textarea>
          		</td>
          	</tr>
	        <tr>

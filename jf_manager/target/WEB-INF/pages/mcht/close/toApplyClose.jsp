...
$(function(){
	...
	$("#confirm").bind('click',function(){
		...
		submitting = true;
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/close/saveApply.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
			data : {"mchtId":mchtId,"applyReason":applyReason},
			timeout : 30000,
...
<body>
	...
	<input type="hidden" id="mchtId" value="${mchtId}">
		<table class="gridtable">
          	<tr>
          		<td class="title">关店类型<span style="color: red;">*</span></td>
          		<td>
          			<input type="radio" value="1" checked="checked">平台介入关店
          		</td>
          	</tr>
          	<tr>
          		<td class="title">申请理由</td>
          		<td>
          			<textarea rows="15" cols="50" id="applyReason" name="applyReason"></textarea>
          		</td>
          	</tr>
	        <tr>

...
function mchtSettleOrderList(mchtCode,needPayAmount){
	$.ligerDialog.open({
		...
		title: "查看结算金额",
		name: "INSERT_WINDOW",
		url: "${pageContext.request.contextPath}/mchtSettleOrder/list.shtml?mchtCode=" + mchtCode+"&needPayAmount="+needPayAmount+"&pay_status_list=1&confirmStatus=-1",
		showMax: true,
		showToggle: false,
		showMin: false,
		isResize: true,
...
function viewSubOrderList(mchtId) {
	$.ligerDialog.open({
		...
		title: "未完成订单",
		name: "INSERT_WINDOW",
		url: "${pageContext.request.contextPath}/mcht/close/viewSubOrderList.shtml?mchtId="+mchtId,
		showMax: true,
		showToggle: false,
		showMin: false,
		isResize: true,
	...
	<input type="hidden" id="interventionOrderCount" value="${interventionOrderCount}">
		...
		<table class="gridtable">
			<tr>
          		...
          		<td>
          			<input type="radio" name="zsConfirmStatus" value="1" <c:if test="${mchtCloseApplicationCustom.zsConfirmStatus == 1}">checked="checked"</c:if> disabled="disabled">同意关店
          			<input type="radio" name="zsConfirmStatus" value="2" <c:if test="${mchtCloseApplicationCustom.zsConfirmStatus == 2}">checked="checked"</c:if> disabled="disabled">不同意关店
          		</td>
          	</tr>
          	...
          	<tr>
          		...
          		<td>
          			<textarea rows="10" cols="80" id="zsRejectReason" name="zsRejectReason">${mchtCloseApplicationCustom.zsRejectReason}</textarea>
          		</td>
          	</tr>
          	</c:if>
		</table>
		...
		<table class="gridtable">
			...
			<tr>
          	...
          	<tr>
          		...
          		<td>
          			<input type="checkbox" id="activityStatus" disabled="disabled">已结束
          	...
          	<tr>
          		...
          		<td>
          			<input type="checkbox" id="commodityStatus" disabled="disabled">已下架
          	...
          	<tr>
          		...
          		<td>
          			<input type="checkbox" id="marketingStatus" disabled="disabled">已全部取消
          		</td>
          	</tr>
			</c:if>
		</table>
		...
		<c:if test="${mchtCloseApplicationCustom.progressStatus == 2}">
			...
			<table class="gridtable">
				<tr>
					<td>店铺关闭是否挂起</td>
					<td>
						<input type="radio" name="fwCloseHangUpStatus" value="1" disabled="disabled" <c:if test="${mchtCloseApplicationCustom.fwCloseHangUpStatus == 1}">checked="checked"</c:if>>是
						<input type="radio" name="fwCloseHangUpStatus" value="0" disabled="disabled" <c:if test="${empty mchtCloseApplicationCustom.fwCloseHangUpStatus || mchtCloseApplicationCustom.fwCloseHangUpStatus == 0}">checked="checked"</c:if>>否
					</td>
				</tr>
				...
				<tr id="mchtArchiveStatusTr" <c:if test="${mchtCloseApplicationCustom.fwCloseHangUpStatus == 1}">style="display: none;"</c:if>>
					...
					<td>
						<input type="checkbox" id="mchtArchiveStatus" disabled="disabled">已齐全&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td>商家全部资料</td>
					<td>
						<input type="checkbox" <c:if test="${mchtCloseApplicationCustom.businessInformationStatus eq 1}">checked="checked"</c:if>>已审核
					</td>
				</tr>
				<tr>
					<td>商家全部资料备注</td>
					<td>
						<textarea rows="15" cols="50">${mchtCloseApplicationCustom.businessInformationRemarks}</textarea>
					</td>
				</tr>
		...
		<c:if test="${mchtCloseApplicationCustom.progressStatus == 3}">
			...
			<table class="gridtable">
				<tr>
					<td>店铺关闭是否挂起</td>
					<td>
						<input type="radio" name="kfCloseHangUpStatus" value="1" disabled="disabled" <c:if test="${mchtCloseApplicationCustom.kfCloseHangUpStatus == 1}">checked="checked"</c:if>>是
						<input type="radio" name="kfCloseHangUpStatus" value="0" disabled="disabled" <c:if test="${empty mchtCloseApplicationCustom.kfCloseHangUpStatus || mchtCloseApplicationCustom.kfCloseHangUpStatus == 0}">checked="checked"</c:if>>否
					</td>
				</tr>
				<tr id="orderConfirmStatusTr" <c:if test="${mchtCloseApplicationCustom.kfCloseHangUpStatus == 1}">style="display: none;"</c:if>>
					...
					<td>
						<input type="checkbox" id="orderConfirmStatus" disabled="disabled">已完成
				...
				<tr id="serviceOrderConfirmStatusTr" <c:if test="${mchtCloseApplicationCustom.kfCloseHangUpStatus == 1}">style="display: none;"</c:if>>
					...
					<td>
						<input type="checkbox" id="serviceOrderConfirmStatus" disabled="disabled">已完成
				...
				<tr id="appealOrderConfirmStatusTr" <c:if test="${mchtCloseApplicationCustom.kfCloseHangUpStatus == 1}">style="display: none;"</c:if>>
					...
					<td>
						<input type="checkbox" id="appealOrderConfirmStatus" disabled="disabled">已完成
				...
				<tr id="interventionOrderConfirmStatusTr" <c:if test="${mchtCloseApplicationCustom.kfCloseHangUpStatus == 1}">style="display: none;"</c:if>>
					...
					<td>
						<input type="checkbox" id="interventionOrderConfirmStatus" disabled="disabled">已完成
				...
				<tr id="threePackagePeriodTr" <c:if test="${mchtCloseApplicationCustom.kfCloseHangUpStatus == 1}">style="display: none;"</c:if>>
					...
					<td>
						<input name="threePackagePeriod" id="threePackagePeriod" disabled="disabled">
					</td>
				</tr>
		...
		<c:if test="${mchtCloseApplicationCustom.progressStatus == 4}">
			...
			<table class="gridtable">
				<tr>
	          		...
	          		<td>
	          			<input type="checkbox" id="paymentOfGoodsConfirm" disabled="disabled">已结清&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="mchtSettleOrderList('${mchtCloseApplicationCustom.mchtCode}',-1);">【查看结算金额】</a>
	          		</td>
	          	</tr>
				<tr>
	          		<td>商家保证金情况</td>
				...
				<tr>
					...
					<td>
							${mchtCloseApplicationCustom.returnedDepositAmount}
					</td>
				</tr>
			</table>
		</c:if>
		<c:if test="${mchtCloseApplicationCustom.progressStatus == 5}">
			...
			<table class="gridtable">
				<tr>
	          		...
	          		<td>
	          			<input type="checkbox" id="endCooperationAgreement" disabled="disabled">已签署
	          		</td>
	          	</tr>
				<tr>
	          		<td>协议出具日期</td>
				...
				<tr>
	          		...
	          		<td>
	          			<input type="text" id="depositDate" name="depositDate" disabled="disabled"/>
	          		</td>
	          	</tr>
			</table>
		</c:if>
		<c:if test="${mchtCloseApplicationCustom.progressStatus == 6}">
			...
			<table class="gridtable">
				<tr>
	          		...
	          		<td>
	          			<input type="checkbox" id="directorConfirmStatus" disabled="disabled">确认关店
	          		</td>
	          	</tr>
			</table>
		</c:if>
		...
		<c:if test="${mchtCloseApplicationCustom.progressStatus == 8}">
			...
			<table class="gridtable">
				...
				<tr>
	          		<td>结算审核</td>
	          		<td><input type="checkbox" id="settlementAuditStatus" disabled="disabled">可结算</td>
	          	</tr>
			</table>
		</c:if>
		<c:if test="${mchtCloseApplicationCustom.progressStatus == 9}">
		...
		<%--	<br>
			...
			<table class="gridtable">
				<tr>
	          		<td>当前需退还的保证金</td>
	          		<td><input type="checkbox" id="depositReturnStatus" disabled="disabled">已退还</td>
	          	</tr>
				<tr>
	          		<td>退还保证金日期</td>
	          		<td><input type="text" id="depositReturnDate" name="depositReturnDate" disabled="disabled"></td>
	          	</tr>
				<tr>
	          		<td>还需支付的货款</td>
	          		<td><input type="checkbox" id="needPayStatus" disabled="disabled">已结清</td>
	          	</tr>
			</table>
		</c:if>
		<c:if test="${mchtCloseApplicationCustom.progressStatus == 10}">
			<br>
			<div>
				<span class="table-title">招商确认(${mchtCloseApplicationCustom.zsStaffName} <fmt:formatDate value="${mchtCloseApplicationCustom.zsConfirmDate}" pattern="yyyy-MM-dd HH:mm"/>)</span>
			</div>
			...
			<br>
			<div>
				<span class="table-title">操作结算(${mchtCloseApplicationCustom.opStaffName}<fmt:formatDate value="${mchtCloseApplicationCustom.opConfirmDate}" pattern="yyyy-MM-dd HH:mm"/>)</span>
			</div>
			<table class="gridtable">
				<tr>
	          		<td>当前需退还的保证金</td>
	          		<td><input type="checkbox" id="depositReturnStatus" disabled="disabled" checked="checked">已退还</td>
	          	</tr>
				<tr>
	          		<td>退还保证金日期</td>
	          		<td><input type="text" id="depositReturnDate" name="depositReturnDate"  value="<fmt:formatDate value="${mchtCloseApplicationCustom.depositReturnDate}" pattern="yyyy-MM-dd"/>" disabled="disabled" checked="checked"></td>
	          	</tr>
				<tr>
	          		<td>还需支付的货款</td>
	          		<td><input type="checkbox" id="needPayStatus" disabled="disabled" checked="checked">已结清</td>
	          	</tr>
			</table>
		</c:if>

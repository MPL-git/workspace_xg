...
$(function(){
	$("#confirm").bind('click',function(){
		...
		submitting = true;
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/mchtInfoChg/saveScopeOfBusiness.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
	...
	<input type="hidden" id="mchtChgId" value="${id}">
		<table class="gridtable">
          	<tr>
          		...
          		<td>
          			<textarea rows="20" cols="80" id="scopeOfBusiness" name="scopeOfBusiness">${scopeOfBusiness}</textarea>
          		</td>
          	</tr>
	        <tr>

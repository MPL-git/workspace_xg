...
$(function(){
	$("#confirm").bind('click',function(){
		...
		if(!remarks){
			commUtil.alertError("不签约理由不能为空");
			return false;
		}
		$.ajax({
			url : "${pageContext.request.contextPath}/mcht/notContract.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
...
<body>
	...
	<input type="hidden" id="mchtId" value="${id}">
		<table class="gridtable">
          	<tr>
          		<td class="title">不签约理由<span style="color: red;">*</span></td>
          		<td>
          			<textarea rows="15" cols="70" id="remarks" name="remarks"></textarea>
          		</td>
          	</tr>
	        <tr>

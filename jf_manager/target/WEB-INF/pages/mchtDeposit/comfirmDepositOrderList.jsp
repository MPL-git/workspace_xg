...
<head>
 ...
 var listConfig={
     url:"/mchtDeposit/comfirmDepositOrderData.shtml",
     listGrid:{ columns: [
...
//									var html = "账户名："+rowdata.platformCapitalAccount.accountName+"<br>开户银行："+rowdata.platformCapitalAccount.paymentName+"<br>银行账号："+rowdata.platformCapitalAccount.accountNo+"<br>打款时间："+new Date(rowdata.payDate).format("yyyy-MM-dd hh:mm:ss")+"<br>交易号："+rowdata.paymentNo;
//									return html;
 	...
 	function excel(){  
		$("#dataForm").attr("action","${pageContext.request.contextPath}/mchtDeposit/comfirmDepositOrderDataExcel.shtml");
		$("#dataForm").submit();
	}

...
$(function(){
	$("#confirm").bind('click',function(){
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/mchtLicenseChg/mchtLicenseChgHandleArchiveUpdate.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
	...
	<input type="hidden" id="id" name="id" value="${mchtLicenseChg.id}">
		<table class="gridtable">
          	<tr>
          		...
          		<td>
          		<input type="radio" name="archiveDealStatus" value="1" <c:if test="${mchtLicenseChg.archiveDealStatus=='1'}">checked="checked"</c:if>>通过
          		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          		<input type="radio" name="archiveDealStatus" value="2" <c:if test="${mchtLicenseChg.archiveDealStatus=='2'}">checked="checked"</c:if>>驳回
          		</td>
          	</tr>
          	<tr>
          		<td class="title">驳回原因</td>
          		<td><textarea style="resize:none;" rows="7" cols="60" id="archiveDealRemarks" name="archiveDealRemarks" maxlength="256">${mchtLicenseChg.archiveDealRemarks}</textarea></td>
          	</tr>
          		<tr>
          		<td class="title">内部备注</td>
          		<td><textarea style="resize:none;" rows="7" cols="60" id="archiveDealInnerRemarks" name="archiveDealInnerRemarks" maxlength="256">${mchtLicenseChg.archiveDealInnerRemarks}</textarea></td>
          	</tr>      	
          	<tr>

...
<html>
<body>
	<form method="post" id="form1" name="form1" action="${pageContext.request.contextPath}/mchtSettled/distribution/submit.shtml">
		...
		<div align="center">
		  <c:if test="${isZs || sessionScope.USER_SESSION.staffID=='1'}">

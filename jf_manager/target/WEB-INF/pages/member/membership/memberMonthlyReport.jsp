...
function seeFunction() {
    listModel.ligerGrid.url = '${pageContext.request.contextPath}/membership/memberMonthlyReportdata.shtml';
...
function memberExplain(){
  ...
  var listConfig={
	  ...
	  url:"/membership/memberMonthlyReportdata.shtml",
      
      listGrid:{ columns: [
                        { display: '统计时间', name:'monthDay'},
		                { display: '新增会员数', name:'memberMonthlydayAdded'},
		                { display: '新增会员消费人数', name:'memberMonthlydayNewlyaddedConsumption'},
		                { display: '活跃会员数', name:'memberMonthlydayActive'},
		                { display: '消费会员数', name:'memberMonthlydayConsumption'},
		                { display: '新增SVIP会员数', name:'memberMonthlydaySvipcount'}	               	            	                
		               ],
...
<body style="padding: 0px; overflow: hidden;">
	...
	<form id="dataForm" runat="server">
		...
		<div class="search-tr"  > 
			<div class="search-td">
			<div class="search-td-label" style="float:left;">统计月份：</div>

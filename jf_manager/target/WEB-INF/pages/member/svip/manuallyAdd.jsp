...
$(function(){
	$("#confirm").bind('click',function(){
		$.ajax({
			url : "${pageContext.request.contextPath}/svipOrder/saveManuallyAdd.shtml",
			type : 'POST',
			dataType : 'json',
			cache : false,
			async : false,
	...
	<div class="title-top">
		<table class="gridtable">
          	<tr>
          		...
          		<td><textarea rows="7" cols="60" placeholder="一行一个商品ID" id="productCodes" name="productCodes">${productCodes}</textarea></td>
          	</tr>      	
          	<tr>
          		<td class="title">操作</td>
          		<td>
					<input id="confirm" type="button" style="float:left;" class="l-button l-button-test" value="提交保存"/>&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
          	</tr>
        </table>
	</div>

...
$(function ()  { 
   ...
   $("#form1").validate({
	...
	<form method="post" id="form1" name="form1"  action="${pageContext.request.contextPath}/order/afterService/addcustomerServiceOrderWorkList.shtml" >
		...
		<table class="gridtable">
				<tr>
	           	...
	           	<tr>
					...
					<td align="left" class="l-table-edit-td" >
						<select style="width: 135px;" id="relevantType" name="relevantType" >
					        ...
					        <option value='5' selected>售后单</option>
					        <option value='6'>其他</option>					
						</select>
					</td>
	           	</tr>
	           	...
	           	<tr>	       
					...
					<td align="left" class="l-table-edit-td" >
						<input style="width:360px;" type="text" id="relevantCode" name="relevantCode" value="${customerServiceOrderCustom.orderCode}" />
					</td>
	           	</tr>

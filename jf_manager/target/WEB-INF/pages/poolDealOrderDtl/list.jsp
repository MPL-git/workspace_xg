...
function viewMcht(orderDtlId,companyName,mchtShortName) {
	$.ligerDialog.open({
 		height: $(window).height()*0.5,
		width: $(window).width()*0.3,
		title: companyName+"("+mchtShortName+")",
		name: "INSERT_WINDOW",
		url: "${pageContext.request.contextPath}/poolDealOrderDtl/viewMcht.shtml?orderDtlId=" + orderDtlId,
		showMax: true,
		showToggle: false,
		showMin: false,
		isResize: true,
  ...
  var listConfig={
      ...
      listGrid:{ columns: [{ display: 'SKU图', render: function(rowdata, rowindex) {
 		                ...
 		                { display: '付款时间', render: function (rowdata, rowindex) {
		                ...
		                { display: '供应商', render: function (rowdata, rowindex) {
		                	return '<a href="javascript:;" onclick="viewMcht('+rowdata.id+','+"'"+rowdata.companyName+"'"+','+"'"+rowdata.mchtShortName+"'"+')">'+rowdata.mchtShortName+'</a>';
		                }},

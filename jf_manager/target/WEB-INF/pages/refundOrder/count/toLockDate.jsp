...
$(function(){
		$("#lockDateBtn").bind('click',function(){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/refundOrder/count/lockDate.shtml",
				type : 'POST',
				dataType : 'json',
				cache : false,
				async : false,
...
<html>
<body>
<form method="post" id="form" name="form" action="${pageContext.request.contextPath}/refundOrder/count/lockDate.shtml">
	        ...
	        <tr>
               ...
               <td colspan="2" align="left" class="l-table-edit-td">
               		<input type="text" id="lockDate" name="lockDate" value="${lockDate}" readonly="readonly"/>（锁住后，其他退款不能用此日期）
				</td>
	        </tr>
	        <tr>

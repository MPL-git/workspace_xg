...
$(function(){
	$("input[name='editDecorateModule']").live('click',function(){
		...
		$.ligerDialog.open({
			...
			title: title,
			name: "INSERT_WINDOW",
			url: "${pageContext.request.contextPath}/appMng/adMng/editSourceNicheDecorateModule.shtml?decorateAreaId=" + decorateAreaId+"&moduleType="+moduleType+"&seqNo="+seqNo+"&decorateModuleId="+decorateModuleId+"&decorateInfoId="+decorateInfoId+"&showType="+showType,
			showMax: true,
			showToggle: false,
			showMin: false,
			isResize: true,

...
function Edit(){
	...
	var channelId =$("#WetaoChannel option:selected").val();
	/* var channelName = $("#channelName").val().trim(); */
	/* var remarks= $("#remarks").val().trim(); */
	if(channelId==""||channelId==null){
		commUtil.alertError("请选择频道");
		return;
	}
	$.ajax({
		url : "${pageContext.request.contextPath}/taobaoke/batchModificationEdit.shtml",
		type : 'POST',
		dataType : 'json',
		cache : false,
		async : false,
		data : {productIds:productIds,channelId:channelId},
		timeout : 30000,
...
<html>
<body>
<form id="violateOrderForm" method="post" action="${pageContext.request.contextPath}/taobaoke/batchModificationEdit.shtml">
	...
	<table class="gridtable">
		...
		<tr>
			...
			<td>
			 <input type="button" class="l-button l-button-submit" onclick="Edit()" value="保存" /> 

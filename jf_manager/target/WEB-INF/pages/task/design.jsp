...
$(function(){
	 ...
	 /* <c:forEach items="${decorateModuleCustoms}" var="decorateModuleCustom" >
	 	<c:if test="${decorateModuleCustom.moduleType == 14}">
	 		$("#graphicContentDiv"+"${decorateModuleCustom.id}").html('${decorateModuleCustom.graphicContent}');
	 		///$("#graphicContentDiv"+"${decorateModuleCustom.id}").html($("#graphicContentDiv"+"${decorateModuleCustom.id}").text());
	 	</c:if>
	 </c:forEach> */
...
function insertGraphicContentModule(){
	var activityAreaModule = '<div style="position: relative;width: 750px;height: 200px;border:1px solid #000" name="moduleDiv" decorateModuleId = "">'+
								'<div style="position: absolute; top:0; left: 0;width: 100%; height: 30px;">'+
									'<div style="float: left;padding-top:7px;padding-left:12px;width:60px;height:23px;background-color:#00CCFF;color:white;">图文模块</div>'+
										'<input type="button" style="margin-left: 20px;float:right;width: 70px;height: 30px;cursor: pointer;" value="删除" name="delete" onclick="del(0,this);">'+
										'<input type="button" style="margin-left: 20px;float:right;width: 70px;height: 30px;cursor: pointer;" value="编辑" name="editDecorateModule" moduleType="14" decorateModuleId="">'+
										'<div style="margin-top: 50px;margin-left: 10px;">'+
									'</div>'+
								'</div>'+
								'<img src="" style="width: 100%;">'+
			...
			<div class="search-tr"  > 
				<div style="display: inline-flex;">
					<div style="padding-left: 10px;">
						<input type="button" style="width: 80px;height: 30px;cursor: pointer;" value="插入图文模块" onclick="insertGraphicContentModule();">
					</div>
					<div style="padding-left: 10px;">
					...
					<div style="position: relative;width: 750px;min-height:180px;border:1px solid #000" name="moduleDiv" decorateModuleId = "${decorateModuleCustom.id}">
						<div style="position: absolute; top:0; left: 0;width: 100%; height: 30px;">
							...
							<c:if test="${!index.last}">
								...
								<input type="button" style="margin-left: 20px;float: right;width: 70px;height: 30px;cursor: pointer;" value="删除" name="delete" onclick="del(${decorateModuleCustom.id},this);">
								<input type="button" style="margin-left: 20px;float: right;width: 70px;height: 30px;cursor: pointer;" value="编辑" name="editDecorateModule" moduleType="14" decorateModuleId="${decorateModuleCustom.id}">
							<div style="margin-top: 40px;margin-left: 10px;width: 740px;height: 137px;overflow: auto;" id="graphicContentDiv${decorateModuleCustom.id}">
								${decorateModuleCustom.graphicContent}
							</div>
						</div>
					</div>
					<br>

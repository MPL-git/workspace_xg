...
<script type="text/javascript">
	...
	<form name="form1" class="form1" method="post" id="form1" action="${pageContext.request.contextPath}/taskSms/auditOrApproveTask.shtml" >
		<input type="hidden" id="taskId" name="taskId" value="${taskSmsCustom.taskId }" />
		<table class="gridtable">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td" >
					<input style="width:435px;" type="text" id="taskName" name="taskName" value="${taskSmsCustom.taskName }" placeholder="限制为1-50个字" disabled="disabled"  />
				</td>
           	</tr>
           	<tr>
				...
				<td align="left" class="l-table-edit-td" >
					...
					<textarea rows="8" cols="60" id="taskContent" name="taskContent" placeholder="请输入发送内容，限制为1-200字" disabled="disabled" onchange="taskContentFun();" >${taskSmsCustom.taskContent }</textarea>
           	...
           	<tr>
				...
				<td align="left" class="l-table-edit-td" >
					...
					<div id="send-date-div" style="margin-left: 5px;display: inline-block;<c:if test='${empty taskSmsCustom.taskSendMode or taskSmsCustom.taskSendMode != 1 }'>display: none;</c:if>" >
						<input type="text" id="taskSendDate" name="taskSendDate" class="dateEditor" disabled="disabled" value="<fmt:formatDate value='${taskSmsCustom.taskSendDate }' pattern='yyyy-MM-dd HH:mm:ss' />" style="width: 135px;" />
					</div>
				</td>
           	</tr>
			<tr>
           	...
           	<tr>
				...
				<td align="left" class="l-table-edit-td" >
					<textarea rows="8" cols="60" id="taskTaskExplain" name="taskTaskExplain" placeholder="请输入任务说明，限制为0-100个字" disabled="disabled" >${taskSmsCustom.taskTaskExplain } </textarea>
				</td>
           	</tr>
           	<tr>
			...
			<c:if test="${taskSmsCustom.taskSendType != '2' }">
      		...
      		<tr>
           	...
           	<c:if test="${taskSmsCustom.taskStatus == '1' }">
           		<tr>
           	...
           	<c:if test="${taskSmsCustom.taskStatus == '2' }">
           		<tr>
           	...
           	<c:if test="${taskSmsCustom.taskStatus == '3' }">
           		<tr>

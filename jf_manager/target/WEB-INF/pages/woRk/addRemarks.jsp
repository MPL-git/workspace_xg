...
$(function ()  { 
	...
	<form method="post" id="form1" name="form1"  action="${pageContext.request.contextPath}/work/addworkremarks.shtml" >
		...
		<table class="gridtable">
	         ...
	         <tr>
				<td class="title">备注内容<span class="required">*</span></td>
				<td align="left" class="l-table-edit-td" >

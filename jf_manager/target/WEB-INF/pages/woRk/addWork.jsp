...
$(function ()  { 
   ...
   $("#form1").validate({
	...
	<form method="post" id="form1" name="form1"  action="${pageContext.request.contextPath}/work/addworklist.shtml" >
		...
		<table class="gridtable">
				<tr>
	           	...
	           	<tr>
					...
					<td align="left" class="l-table-edit-td" >
						<select style="width: 135px;" id="workType" name="workType">
					        ...
					        <option value='7' <c:if test="${workType == 7}">selected</c:if>>产权投诉</option>
	           	...
	           	<tr>	      
					...
					<td align="left" class="l-table-edit-td" >
						<select style="width: 135px;" id="urgentDegree" name="urgentDegree">
					        ...
					        <option value='4' <c:if test="${urgentDegree == 4}">selected</c:if>>重要紧急</option>					
						</select>
					</td>
	           	</tr>
	           	...
	           	<tr>
					...
					<td align="left" class="l-table-edit-td" >
						<select style="width: 135px;" id="relevantType" name="relevantType">
					        ...
					        <option value='4'>子订单</option>
					        <option value='5'>售后单</option>
					        <option value='7' <c:if test="${relevantType == 7}">selected</c:if>>产权投诉单</option>
	        				<option value='6'>其他</option>	
						</select>
					</td>
	           	</tr>
	           	...
	           	<tr>	       
					...
					<td align="left" class="l-table-edit-td" >
						<input style="width:360px;" type="text" id="relevantCode" name="relevantCode" value="${relevantCode}" />
					</td>
	           	</tr>

...
$(function(){
	$("#form1").validate({
        submitHandler: function(form) {  
        	var orgId = $("#orgId").val();
   		    if(orgId == '') {	    
   		      commUtil.alertError("指派部门不能为空！");
   		       return;
   		    }	    
    		var staffId = $("#staffId").val();
    		var urgentDegree = $("#urgentDegree").val();
    		if(staffId == '') {
        		commUtil.alertError("指派人不能为空！");
        		return;
        	}
     
        	if(urgentDegree=='') {
        	    commUtil.alertError("紧急程度不能为空！");
    			return;
        	}
...
function staffIdinfo() {
	...
	<form method="post" id="form1" name="form1"  action="${pageContext.request.contextPath}/work/changeassign.shtml" >
						...
						<span style="margin-left: 20px;" >
							<select style="width: 135px;" id="staffId" name="staffId" >
								...
								<c:forEach var="sysStaffInfolist" items="${sysStaffInfolist}">
									<option value="${sysStaffInfolist.staffId }"> 

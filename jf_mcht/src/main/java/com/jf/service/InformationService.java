...
public class InformationService extends BaseService<Information,InformationExample> {
    ...
    public List<InformationCustom> selectByExampleCustom(Map<String,Object> map) {
		return informationCustomMapper.selectByExampleCustom(map);
    }

	public Integer selectCountCustom(Map<String, Object> map) {
		return informationCustomMapper.selectCountCustom(map);
	}
}

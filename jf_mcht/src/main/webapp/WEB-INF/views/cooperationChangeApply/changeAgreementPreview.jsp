...
<div class="modal-dialog" role="document" style="width:1200px;">
	<div class="modal-content">
		<div class="modal-header">
			...
			<span class="modal-title" id="exampleModalLabel">变更合作协议书预览</span>
		</div>
...
<script type="text/javascript">
	...
	$(function () {
		if(isIE()){
			...
			$("#printIframe").attr("src", "${ctx}/cooperationChangeApply/changeAgreementPDF?id=${cooperationChangeApply.id}");
		}
	});
	...
	function downloadContract(){
		window.location.href = "${ctx}/file_servelt/${cooperationChangeApply.filePath}";
	}

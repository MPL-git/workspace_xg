...
<script>
	...
	$(document).ready(function () {
		tables = $('#datatables').dataTable({
			"ajax": function (data, callback, settings) {
				...
				$.ajax({
					method: 'POST',
					url: '${ctx}/market/productList?activityType='+${activityType},
					data: param,
					dataType: 'json'
	...
	function addTable(productId){
		...
		$.ajax({
    	    ...
    	    success: function(data){
    	    	var html = "";
    	    	html+='<tr><td height="100	"><div style="margin-left: 15px;">';
                if(data.pic){
                ...
                html+='<div class="width-226"><a href="https://m.xgbuy.cc/share_buy.html?id='+data.code+'" target="_blank">'+data.name+'</a><p style="color: #999;margin: 5px 0 0;">货号：'+data.artNo+'&nbsp;&nbsp;&nbsp;&nbsp;</p><p style="color: #999;margin: 5px 0 0;">ID：'+data.code+'</p></div>';
                html+='</div></td>';

                if(${activityType ne '11'}){//活动类型不等于积分抽奖

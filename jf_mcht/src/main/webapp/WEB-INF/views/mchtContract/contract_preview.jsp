...
<div class="modal-dialog" role="document" style="width:1200px;">
	<div class="modal-content">
		<div class="modal-header">
			...
			<span class="modal-title" id="exampleModalLabel">预览合同</span>
		</div>
...
<script type="text/javascript">
	...
	$(function () {
		if(isIE()){
			...
			$("#printIframe").attr("src", "${ctx}/mcht/contract/contractPDF?id=${contract.id}");
		}
	});
	...
	function downloadContract(){
		window.location.href = "${ctx}/file_servelt/${contract.filePath}";
	}

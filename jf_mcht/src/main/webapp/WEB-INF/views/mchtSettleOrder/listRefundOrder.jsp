    ...
    $(document).ready(function () {
        table = $('#datatable').dataTable({
            "ajax": function (data, callback, settings) {
                ...
                $.ajax({
                    method: 'POST',
                    url: '${ctx}/mchtSettleOrder/listRefundOrder',
                    data: param,
                    dataType: 'json'
            ...
            "columns": [
                ...
                {"data": "orderCode", "render":function(data,type, row, meta){
                    var html = [];
                    html.push('<a class="table-opr-btn" href="javascript:void(0);" onclick="refundDetail(', "'"+row.id+"'", ');" >', data ,'</a>');
                    return html.join("");
                }},
                {"data": "amount"}
            ]

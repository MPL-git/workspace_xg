...
<!--查看品牌 -->
  <div class="modal-dialog" role="document">
    ...
    <input type="hidden" id="mchtLicenseChgId" value="${id}">
...
$(function(){
	...
	$("#send").on('click',function(){
		...
		var mchtLicenseChgId = $("#mchtLicenseChgId").val();
		...
		$.ajax({
		        method: 'POST',
		        url: '${ctx}/mchtUser/mchtLicenseChg/send',
		        data: {"id":mchtLicenseChgId,"expressId":expressId,"expressNo":expressNo},
		        dataType: 'json'

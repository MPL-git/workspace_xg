			...
			<table class="table table-bordered ">
				<tbody>
				    <tr>
						...
						<input   type="text" id="userCode" name="userCode" value="${mchtUser.userCode}" validate="{required:true,userCodeUnique:true}" disabled="disabled">
						<a href="javascript:void(0);" onclick="$('#userCode').attr('disabled',false)">修改</a>
						</td>
					</tr>
				    <tr>
						<td class="editfield-label-td">密码</td>
						<td colspan="2" class="text-left">
						<input   type="password" id="oldPassword" name="oldPassword" value="" validate="{required:true}">
						</td>
					</tr>
				    <tr>
						<td class="editfield-label-td">新密码</td>
						<td colspan="2" class="text-left">
						<input   type="password" id="newPassword" name="newPassword" value="" validate="{minlength:10}">
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="2" class="text-left">
						<input   type="password" id="confirmPassword" name="confirmPassword" value="" validate="{passwordRequired:true,minlength:10}" >
						</td>
					</tr>
					<tr>
						<td class="editfield-label-td">绑定邮箱</td>
						<td colspan="2" class="text-left">
						<input   type="text" id="email" name="email" value="${mchtUser.email}" validate="{email:true}">
						</td>
					</tr>
					<tr>
						<td class="editfield-label-td">绑定手机</td>
						<td colspan="2" class="text-left">
						<input   type="text" id="mobile" name="mobile" value="${mchtUser.mobile}" validate="{required:true}" disabled="disabled">
						<a href="javascript:void(0);" onclick="$('#mobile').attr('disabled',false)">修改</a>
						</td>
					</tr>
					<tr>
						<td class="editfield-label-td">短信验证码</td>
						<td colspan="2" class="text-left">
						<input   type="text" id="mobileValidateCode" name="mobileValidateCode" value="" validate="{required:true}">

  ...
  <div class="modal-dialog" role="document" style="width:500px;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <span class="modal-title" id="exampleModalLabel">手机验证</span>
      </div>
			<div class="modal-body">
				<form id="dataFrom" class="form-horizontal">
					...
					<div class="form-group">
						<label for="mobile" class="col-md-3 control-label">您绑定手机号</label>
						<div class="col-md-9">
							<input type="text" value="${mobile }" name="mobile"  id="mobile" class="form-control" readonly="readonly">
						</div>
					</div>
					<div class="form-group">
...
var timer = 0;
	...
	function commit() {
		...
		if ($.trim($("#validateCode").val()) == "") {
			...
			$.ajax({
				url : "${ctx}/mchtUser/bindMobileCommit",
				type : 'POST',
				dataType : 'json',
				cache : false,
				async : false,

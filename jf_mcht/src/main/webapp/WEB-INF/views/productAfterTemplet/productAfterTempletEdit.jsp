				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2" class="text-left">
						   ...
						   <option value="${productBrand.productBrandId}" <c:if test="${productBrand.productBrandId==productAfterTemplet.brandDef}">selected="selected"</c:if> >${productBrand.productBrandName}</option>
						   </c:forEach>
                          </select>
						</td>
					</tr>
					...
					<tr>
						...
						<select style="width:100px;" class="province-select" onchange="onchangeProvince();" name="province" id="province" validate="{required:true}">
                         ...
                         <br>
                         <br>
						<input style="width:400px;" type="text" id="address" name="address" value="${productAfterTemplet.address}" validate="{required:true,maxlength:100}">
						</td>
					</tr>
					<tr>

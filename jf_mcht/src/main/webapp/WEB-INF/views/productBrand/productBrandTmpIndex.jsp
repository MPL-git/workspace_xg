...
<body>
	<div class="x_panel container-fluid">
		...
		<div class="row content-title">
			<div class="col-md-12 ">您已申请的新品牌</div>
		</div>
...
$(document).ready(function () {
    table = $('#datatable').dataTable({
        "ajax": function (data, callback, settings) {
            ...
            $.ajax({
                method: 'POST',
                url: '${ctx}/productBrand/getProductBrandTmpList',
                data: param,
                dataType: 'json'
        ...
        "columns": [
            ...
            {"data": "status","render": function (data, type, row, meta) {
            		return "<a class='table-opr-btn' href='javascript:void(0);' onclick='viewProductBrandTmp("+row.id+")' >【查看】</a>";
            }},
        ]
    }).api();
...
function viewProductBrandTmp(id){
	$.ajax({
        url: "${ctx}/productBrand/productBrandTmpEdit?id="+id, 
        type: "GET", 

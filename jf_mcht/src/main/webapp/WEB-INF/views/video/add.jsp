...
<div class="x_panel container-fluid">
    <div class="row content-title">
        <div class="col-md-12 t-title">添加视频
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="text-left">
                            <div id="videoCoverContainer">
                                <ul class="docs-pictures clearfix td-pictures" id="coverList"></ul>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="text-left">
                            <textarea rows="5" class="txt-area" id="description" placeholder="最多可以输入100个字"
                                      maxlength="100"
                                      onkeyup="$('#descriptionLength').text(100-($('#description').val().length));"></textarea>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="text-left">
                            <a href="javascript:;" id="videoA" class="file" style="line-height: 30px;">
                                ...
                                <input type="hidden" id="fullVideoUrl" name="fullVideoUrl">
                            ...
                            <div style="display: none;height: 150px;">
                                <ul id="imgBox">
                                    <li>
                                        <a href="javascript:;">
                                            <img src="" style="width: 200px;height: 133.33px;" id="videoCover"
                                                 onclick="toShowVideo();"/>
                        ...
                        <td colspan="2" class="text-left">
                            <select class="ad-select"  onchange="changeSource()"  name="videoSource" id="videoSource" validate="{required:true}" style="">
                                ...
                                <c:forEach var="videoSource" items="${videoSourceStatusList}">
                                    <option value="${videoSource.statusValue}">${videoSource.statusDesc}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="text-left">
                            ...
                            <div class="form-group">
                                ...
                                <a href="http://p1.xgbuy.cc/download/声明书2019.10.21.docx " style="line-height: 30px;vertical-align: top;" >&nbsp;&nbsp;肖像权声明书模板</a>
                            </div>

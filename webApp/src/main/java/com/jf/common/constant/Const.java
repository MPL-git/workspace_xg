...
public class Const {
	...
	/**webApp */
	public static final String WEB_APP = "4";	//webApp微信公众号
	/**Micro mall 微商城 */
	public static final String MICRO_MALL = "3";	//Micro mall
	/**小程序*/
	public static final String WX_XCX = "5";	//Micro mall
	/**抖音*/
	public static final String H5_DY = "6";	//抖音
	...
	public static final String INTEGRAL_TYPE_ALLOWANCE_EXCHANGE = "21";	//津贴兑换
	public static final String INTEGRAL_TYPE_INTEGRAL_LOTTERY_OUT = "22";	//积分转盘扣除
	public static final String INTEGRAL_TYPE_INTEGRAL_LOTTERY_IN = "23";	//积分转盘奖励


	// 系统类型值
	public static final String PAY_ZFB = "1";	//支付宝
	public static final String PAY_WX = "2";	//微信
	public static final String PAY_WX_PUBLIC = "4";	//微信公众号支付
	public static final String PAY_H5_WX = "5";	//微信H5支付
	public static final String PAY_H5_ZFB = "6";	//支付宝H5支付
	...
	public static final String COMBINE_ORDER_CUT_ORDER = "3";	//砍价订单
	public static final String COMBINE_ORDER_FREE_SHEET_ORDER = "4";	//邀请享免单
	public static final String COMBINE_ORDER_SIGN_IN_ORDER = "5";	//签到订单
	public static final String COMBINE_ORDER_ASSISTANCE_CUT_PRICE = "6";	//助力大减价
	...
	//广告类型(1 广告图 2 推荐活动)
	public static final String AD_TYPE_1 = "1";	//会场
	public static final String AD_TYPE_2 = "2";	//活动
	...
	//广告位置(1 头部海报 2 广告位1 3 广告位2 4 首页新用户专区 5首页秒杀专区 6 首页爆款专区 7 首页品牌专区 9 推荐区域10 积分商城11 断码清仓12 首页主题馆)
	...
	public static final String AD_POSITION_HOME_MARKETING = "13";
	public static final String AD_POSITION_HOME_PRDUCT_DETAIL_MARKETING = "14";
	...
	public static final String PRODUCT_ACTIVITY_TYPE_PRESELL = "11";	//预付会场
	...
	// app消息记录表（sys_app_message）  
		...
		//TITLE标题
		public static final String MEMBER_ACCOUNT_BIZ_TYPE_SIGN_IN = "1";	//1签到
		public static final String MEMBER_ACCOUNT_BIZ_TYPE_PUT_FORWARD = "2";	//2 提现
		public static final String MEMBER_ACCOUNT_BIZ_TYPE_COUPON = "3";	//3 兑换优惠券
		public static final String MEMBER_ACCOUNT_BIZ_TYPE_FREEZE = "4";	//4冻结
		public static final String MEMBER_ACCOUNT_BIZ_TYPE_FRIEND_SIGN_IN = "5";	//5 好友签到
		public static final String MEMBER_ACCOUNT_BIZ_TYPE_SIGNATURE = "6";	//5连签好包
		
		/**自定义广告页类型 
		1 首页主题管 2 日常营销入口 3 商品主题馆 4 现金签到 5 砍价免费拿 6 购物车 7 消息 8 商品未上架9:邀请享免单  10:小程序页面--首页栏目装修  
		11:H5装修页面--首页栏目装修 12:有好货 13:每日好店 14:潮鞋上新 15:潮流男装 16:断码特惠 17:运动鞋服 18:潮流美妆 19:食品超市 20:五粒导航 21:醒购店长权益介绍22.大学生创业23.SVIP 24.领券中心*/
		...
		//助力大减价 付款倒计时时长
		public static final int ASSISTANCE_ACTIVITY_COUNT_DOWN_HOURS = 24;

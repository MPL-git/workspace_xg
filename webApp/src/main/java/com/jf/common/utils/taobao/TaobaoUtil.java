package com.jf.common.utils.taobao;
...
public class TaobaoUtil {
	...
	private static final String appKey = "25108234"; // 可替换为您的沙箱环境应用的appKey
	private static final String appSecret = "37c185255cfac221df8d5a7776d9ba31"; // 可替换为您的沙箱环境应用的appSecret
	...
	private static String getSellerItem() throws IOException {
		...
		// 业务参数
		params.put("fields", "num_iid,title,pict_url");
//		params.put("num_iids", "564297327156");

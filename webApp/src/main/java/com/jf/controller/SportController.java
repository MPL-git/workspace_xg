...
public class SportController extends BaseController{
	 ...
	 * @return
	 */
	@RequestMapping(value = "/api/y/getSportList")
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping(value = "/api/y/addSportGuess")
	@ResponseBody
	public ResponseMsg addSportGuess(HttpServletRequest request){
		try {
			JSONObject reqPRM = (JSONObject) request.getAttribute("reqPRM");
			JSONObject reqDataJson = reqPRM.getJSONObject("reqData");// 获取请求参数
			Object[] obj = {"type","integral"};
	 ...
	 * @return
	 */
	@RequestMapping(value = "/api/y/getSportGuessRecord")
	@ResponseBody
	...
	@RequestMapping(value = "/api/n/getIntegralTask")
	@ResponseBody
	...
	@RequestMapping(value = "/api/y/addMemberIntegralTask")
	@ResponseBody
	public ResponseMsg addMemberIntegralTask(HttpServletRequest request){
		try {
			Integer memberId = getMemberId(request);

...
public class OrderDtlCustom extends OrderDtl{
	...
	/**  
	 * 子订单积分优惠金额  
	 * @param subIntegralPreferential 子订单积分优惠金额  
	 */
	...
	/**  
	 * 总订单积分优惠金额  
	 * @param combineIntegralPreferential 总订单积分优惠金额  
	 */
	public void setCombineIntegralPreferential(BigDecimal combineIntegralPreferential) {
	...
	/**  
	 * 总订单实付金额  
	 * @param combinePayAmount 总订单实付金额  
	 */
	...
	/**  
	 * 总订单状态，0未付1已付4取消  
	 * @param combineOrderStatus 总订单状态，0未付1已付4取消  
	 */

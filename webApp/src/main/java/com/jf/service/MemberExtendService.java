...
public class MemberExtendService extends BaseService<MemberExtend, MemberExtendExample> {
	...
	public void addModel(Integer memberId, String thirdPartyMark, String thirdPartyId) {
		...
		}else if("platformContactId".equals(thirdPartyMark)){
			memberExtend.setZsPlatformContactId(Integer.parseInt(thirdPartyId));
		}

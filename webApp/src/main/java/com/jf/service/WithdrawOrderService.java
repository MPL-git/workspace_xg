...
public class WithdrawOrderService extends BaseService<WithdrawOrder,WithdrawOrderExample> {
	 ...
	 * @param memberInfo 
	 */
	public void applyCashWithdraw(JSONObject reqPRM, JSONObject reqDataJson, MemberInfo memberInfo) {
		...
		//日志
		withdrawOrderStatusLogService.addLog(withdrawOrder.getId(),"0",memberId);
		//判断余额是否足够 且更新冻结金额

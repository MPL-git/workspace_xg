...
public class CouponRainSettleService {
    ...
    private Coupon randomOneAreaCoupon(Integer memberId, CouponRainSetup setup) {
        Map<String, Object> params = buildRandomParams(memberId, setup);
        return couponRainCustomMapper.randomOneAreaCoupon(params);
    }

    private Coupon randomOneProductCoupon(Integer memberId, CouponRainSetup setup) {
        Map<String, Object> params = buildRandomParams(memberId, setup);
        return couponRainCustomMapper.randomOneProductCoupon(params);
    }

    private Coupon randomOnePlatformCoupon(Integer memberId, CouponRainSetup setup, Integer originScore) {
        Map<String, Object> params = buildRandomParams(memberId, setup);

...
function getMapUrl(_this) {
	var _type = $(_this).attr('data-type'),
		...
		_videoid = $(_this).attr('data-videoid'),
	...
	if (_type == 1) {
		...
		if (_link == 1) {
			...
			var _url1 = location_href.split('/views/')[0] + '/views/' + redirect_url + 'main_venue/index.html';
			console.log(_url1)
	...
	} else if (_type == 18 || _type == 20 || _type == 22 || _type == 24 || _type == 26 || _type == 28 || _type == 30) {

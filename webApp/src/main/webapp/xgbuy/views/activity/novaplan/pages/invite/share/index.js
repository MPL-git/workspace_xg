var a_invite_share_page = $('.page[data-id="activity_novaplan_pages_invite_share"]:visible'),
	...
	package: function () {
		new ajax(getApi.couponEnjoy, {
			...
			success: function () {
				...
				setTimeout(function () {
					getUrl('activity/novaplan/pages/invite/share/success/index.html', 'self');
				}, 2e3);
			}
		});
	},

	pageScroll: function (_this) {
		var _top = font_size * 8;
		a_invite_share_page.find('.scroll-y').scrollTop(_top);
	}
};

var address_list = $('.page[data-id="activity_pointsLottery_address_list"]:visible'),
...
var addressList = {
	...
	default: function (that) {
		...
		getUrl('activity/pointsLottery/record/index.html', winningRecordApi.getMemberAddress());
	}
};
